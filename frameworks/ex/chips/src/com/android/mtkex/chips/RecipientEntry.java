...
public class RecipientEntry {
    ...
    private RecipientEntry(
        ...
        this(entryType, displayName, destination, destinationType, destinationLabel,
            contactId, dataId, photoThumbnailUri, isFirstLevel, true, true);
    }
    ...
    /// M: MTK version
    public static RecipientEntry constructFakeEntry(final String address) {
        return constructFakeEntry(address, true);
    }
    ...
    public String nameAndNumber() {
        ...
        if(mDisplayName == mDestination)
        {
            nameAndNumber = mDisplayName;
        }else
        {
            nameAndNumber = mDisplayName + " <" + mDestination + ">";
        }
