...
private volatile boolean mIsMagcommLockerShowing;//added by yzs for MagcommLocker
    ///M: added for ALPS02740947
    ...
    @Override
    public void onMagcommLockerShowingStateChanged(boolean showing) {
        mIsMagcommLockerShowing = showing;
    }
