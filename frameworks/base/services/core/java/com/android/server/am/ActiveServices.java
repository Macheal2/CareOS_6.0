...
public final class ActiveServices {
    ...
    ComponentName startServiceLocked(IApplicationThread caller, Intent service, String resolvedType,
        ...
        if (caller != null) {
            ...
            if (!ActivityManagerService.IS_USER_BUILD) Slog.v(TAG, "startService: " + service
                    + " callerApp=" + callerApp);
            /// @}
            if (callerApp == null) {
...
/* Cappu:lau on: Sat, 15 Jul 2017 14:10:23 +0800
 * TODO: 隐藏讯飞语音 手机百度 应用权限 正在运行中 
 */
        //liukun
        /*
        if( className.getPackageName().equals("com.iflytek.speechcloud") ){  
            return;  
        }
        */
        if(className.getPackageName().equals("com.baidu.searchbox")){
            return;
        }
        if(className.getPackageName().equals("com.mediatek.security")){
            return;
        }
// End of Cappu:lau
    ...
    private final void realStartServiceLocked(ServiceRecord r,
        ...
        try {
            ...
            /// AMS log enhancement @{
            if (!ActivityManagerService.IS_USER_BUILD) Slog.v(TAG, "AMS Creating service " + r);
            /// @}
    ...
    private final void sendServiceArgsLocked(ServiceRecord r, boolean execInFg,
        ...
        while (r.pendingStarts.size() > 0) {
            ...
            try {
                ...
                if (DEBUG_SERVICE) Slog.v(TAG_SERVICE, "Transaction too large");
                caughtException = e;
            } catch (RemoteException e) {
