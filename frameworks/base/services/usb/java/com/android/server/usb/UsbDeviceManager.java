...
public class UsbDeviceManager {
   ...
   //By zhouuha 20170818 add begin default mtp
    private boolean mUsbChangerEnabled=false;
   //By zhouuha 20170818 add begin default mtp
    ...
    private final class UsbHandler extends Handler {
        ...
        private boolean mUsbDataUnlocked=true;// by zhouhua 20170818  add mtp mode
        ...
        public void updateState(String state) {
            ...
            if ("HWDISCONNECTED".equals(state)) {
		        ...
		        mUsbDataUnlocked = false;//by zhouhua 20170818 add mtp		
            ...
            if (id != mUsbNotificationId) {
                ...
                if (mUsbNotificationId != 0) {
                    mNotificationManager.cancelAsUser(null, mUsbNotificationId,
                            UserHandle.ALL);
                    mUsbNotificationId = 1;//by zhouhua 20170818  add default mtp //0
                }
                if (id != 0) {
