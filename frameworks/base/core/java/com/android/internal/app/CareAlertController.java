...
public class CareAlertController {
    ...
    public CareAlertController(Context context, DialogInterface di, Window window) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
        ...
        TypedArray a = context.obtainStyledAttributes(null,
                ...
                com.android.internal.R.attr.alertDialogCareStyle, 0);
    ...
    private void setupView() {
        ...
        final TypedArray a = mContext.obtainStyledAttributes(
                null, R.styleable.AlertDialog, R.attr.alertDialogCareStyle, 0);
    ...
    private void setBackground(TypedArray a, View topPanel, View contentPanel, View customPanel,
        ...
        if(mThemeManager.getThemeType(mContext) == ThemeManager.THEME_CLASSICAL){
        	topPanel.setBackgroundResource(R.drawable.care_dialog_title_bg_green);
        }else{
        	topPanel.setBackgroundResource(R.drawable.care_dialog_title_bg_blue);
        }
    ...
    public static class AlertParams {
        ...
        public void apply(CareAlertController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final CareAlertController dialog) {
