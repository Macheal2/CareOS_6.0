...
public class PreferenceManager {
    ...
    public static SharedPreferences getDefaultSharedPreferences(Context context) {
        //dengjianzhang@20160312 by weixin daziti start
        ...
        if(context.getPackageName().equals("com.tencent.mm") ){
            Float f=prefs.getFloat("current_text_size_scale_key", 2.0f);
            if(f==2.0f){
                SharedPreferences.Editor editor = prefs.edit();
                editor.putFloat("current_text_size_scale_key",1.25f);       
                editor.putFloat("text_size_scale_key",1.25f);  
                editor.apply();
            }
        }
        return prefs;
...
//                getDefaultSharedPreferencesMode());
        //dengjianzhang@20160312 by weixin daziti end
    }
