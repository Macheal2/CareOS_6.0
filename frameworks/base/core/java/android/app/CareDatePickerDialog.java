...
import android.widget.CareDatePicker.OnDateChangedListener;
import android.widget.CareDatePicker.ValidationCallback;
 ...
 * guide.</p>
 */
public class CareDatePickerDialog extends CareDialog implements OnClickListener,
     ...
     */
    public CareDatePickerDialog(Context context,
     ...
     * @param dayOfMonth The initial day of the dialog.
     */
    public CareDatePickerDialog(Context context, int theme, OnDateSetListener listener, int year,
        ...
        final View view = inflater.inflate(R.layout.care_date_picker_dialog, null);
        setView(view);
    ...
    /**
     * Gets the {@link CareDatePicker} contained in this dialog.
     *
    ...
    private void updateTitle(int year, int month, int day) {
        Log.e("hmq","careDatePicker updateTitle");
