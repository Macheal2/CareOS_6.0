...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    //dengying add key begin
    /**
     * @hide
     */
    public static final int KEYCODE_HALL = 266;

    /**
     * @hide
     */
    public static final int KEYCODE_HALL_RELEASE = 267;  
    //dengying add key end
    ...
    // add key fm and torch by zxy begin
    /**
     * @hide
     */
     ...
     * @hide
     */
    public static final int KEYCODE_TORCH = 301;  
    // add key fm and torch by zxy end

    private static final int LAST_KEYCODE = KEYCODE_TORCH; //add key torch by zxy
