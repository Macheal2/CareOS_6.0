...
public final class Settings {
            ...
            if (isSelf) {
                ...
                synchronized (this) {
                    ...
                    if (mValues.containsKey(name)) {
                        ...
                        Log.d(TAG, " from settings cache , name = " + name + " , value = " + value);
    ...
    public static final class System extends NameValueTable {
        ...
        /**
          * M: Video player step option value
          * Save op02 video plugin step option ALPS02274002
          * * @hide
          */
         public static final String VIDEO_STEP_OPTION = "selected_step_option";
         private static final Validator VIDEO_STEP_OPTION_VALIDATOR = sNonNegativeIntegerValidator;

         /**
          * M: WPS NFC public key
          * * @hide
          */
         public static final String WPS_NFC_KEY = "wps_nfc_pubkey";
         private static final Validator WPS_NFC_KEY_VALIDATOR = sBooleanValidator;

         /**
          * M: WIFI WPS NFC config
          * * @hide
          */
         public static final String WPS_EM_WIFI_OPTION = "wps_em_wifi_enable";
         private static final Validator WPS_EM_WIFI_OPTIONN_VALIDATOR = sBooleanValidator;

         /**
          * M: P2P WPS NFC config
          * * @hide
          */
         public static final String WPS_EM_P2P_OPTION = "wps_em_p2p_enable";
         private static final Validator WPS_EM_P2P_OPTION_VALIDATOR = sBooleanValidator;
        ...
        /**
         * M: permission control switch off dialog state
         * @hide
         */
        public static final String PERMISSION_SWITCH_OFF_STATE = "permission_switch_off_dlg_state";
        private static final Validator PERMISSION_CONTROL_VALIDATOR = sBooleanValidator;
       ...
       /**
        ...
        /**
         * M: CR ALPS02301563, for unread contacts num.
         * @hide
         */
        public static final String CONTACTS_UNREAD_KEY = "com_android_contacts_mtk_unread";

        /**
         * M: CR ALPS02301563, for unread mms num.
         * @hide
         */
        public static final String MMS_UNREAD_KEY = "com_android_mms_mtk_unread";

        /**
         * M: CR ALPS02301563, for unread email num.
         * @hide
         */
        public static final String EMAIL_UNREAD_KEY = "com_android_email_mtk_unread";

        /**
         * M: CR ALPS02301563, for unread calendar num.
         * @hide
         */
        public static final String CALENDAR_UNREAD_KEY = "com_android_calendar_mtk_unread";
        /**

         * M: CR ALPS02301563, for unread rcse num.
         * @hide
         */
        public static final String RCSE_UNREAD_KEY = "com_android_rcse_mtk_unread";

        /**
         * M: CR ALPS02301563, for unread cellbroadcastreceiver num.
         * @hide
         */
        ...
        static {
            ...
            PUBLIC_SETTINGS.add(VIDEO_STEP_OPTION);
            PUBLIC_SETTINGS.add(WPS_NFC_KEY);
            PUBLIC_SETTINGS.add(WPS_EM_WIFI_OPTION);
            PUBLIC_SETTINGS.add(WPS_EM_P2P_OPTION);
            PUBLIC_SETTINGS.add(PERMISSION_CONTROL_STATE);
            PUBLIC_SETTINGS.add(PERMISSION_CONTROL_ATTACH);
            PUBLIC_SETTINGS.add(PERMISSION_SWITCH_OFF_STATE);
            PUBLIC_SETTINGS.add(VOICE_UNLOCK_SCREEN);
            PUBLIC_SETTINGS.add(VOICE_UNLOCK_AND_LAUNCH1);
            PUBLIC_SETTINGS.add(VOICE_UNLOCK_AND_LAUNCH2);
            PUBLIC_SETTINGS.add(VOICE_UNLOCK_AND_LAUNCH3);
            PUBLIC_SETTINGS.add(DM_BOOT_START_ENABLE_KEY);
            PUBLIC_SETTINGS.add(MSIM_MODE_SETTING);
            PUBLIC_SETTINGS.add(ROAMING_REMINDER_MODE_SETTING);
            PUBLIC_SETTINGS.add(GPRS_CONNECTION_SIM_SETTING);
            PUBLIC_SETTINGS.add(VOICE_CALL_REJECT_MODE);
            PUBLIC_SETTINGS.add(VOICE_CALL_SIM_SETTING);
            ...
            PUBLIC_SETTINGS.add(WIFI_HOTSPOT_AUTO_DISABLE);
            PUBLIC_SETTINGS.add(WIFI_HOTSPOT_MAX_CLIENT_NUM);
            PUBLIC_SETTINGS.add(WIFI_HOTSPOT_START_TIME);
            ...
            PUBLIC_SETTINGS.add(CURRENT_WALLPAPER_NAME);
            PUBLIC_SETTINGS.add(SCREEN_BRIGHTNESS_ECO_MODE);
            ...
            PUBLIC_SETTINGS.add(DATA_SAVING_KEY);
            ...
            PUBLIC_SETTINGS.add(CONTACTS_UNREAD_KEY);
            PUBLIC_SETTINGS.add(MMS_UNREAD_KEY);
            PUBLIC_SETTINGS.add(EMAIL_UNREAD_KEY);
            PUBLIC_SETTINGS.add(CALENDAR_UNREAD_KEY);
            PUBLIC_SETTINGS.add(RCSE_UNREAD_KEY);
            PUBLIC_SETTINGS.add(CELLBROADCAST_UNREAD_KEY);
        }
        ...
        static {
            ...
            /// M: Add MTK provider validator Start.
            VALIDATORS.put(VIDEO_STEP_OPTION, VIDEO_STEP_OPTION_VALIDATOR);
            VALIDATORS.put(WPS_NFC_KEY, WPS_NFC_KEY_VALIDATOR);
            VALIDATORS.put(WPS_EM_WIFI_OPTION, WPS_EM_WIFI_OPTIONN_VALIDATOR);
            VALIDATORS.put(WPS_EM_P2P_OPTION, WPS_EM_P2P_OPTION_VALIDATOR);
            VALIDATORS.put(PERMISSION_CONTROL_STATE, PERMISSION_CONTROL_VALIDATOR);
            VALIDATORS.put(PERMISSION_CONTROL_ATTACH, PERMISSION_CONTROL_VALIDATOR);
            VALIDATORS.put(PERMISSION_SWITCH_OFF_STATE,PERMISSION_CONTROL_VALIDATOR);
        }
       ...
       /**
         ...
         */
		//modify hejianfeng@20150601 start
		/**
         * Record font scale from EM
         * 
         * @hide
         */
	    public static final String HALL_CLOSE = "hall_close";
		
		/**
         * Enable HALL? true = yes false = no
         * 
         * @hide
         */
		public static final String HALL_SETTING = "hall_setting";
		//modify hejianfeng@20150601 end
        public static boolean canWrite(Context context) {
          ...
          *
          */
         public static String CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL = "cappu_settings_pictorial";
         
         /**
          * 画报墙纸开
          */
         public static final int CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL_ON = 0;

         /**
          * 画报墙纸关
          */
         public static final int CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL_OFF = 1;
          ...
          *
          */
         public static String CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL = "cappu_settings_pictorial_random";
         /**
          * 画报墙纸随机开
          */
         public static final int CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL_ON = 0;

         /**
          * 画报墙纸随机关
          */
         public static final int CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL_OFF = 1;
