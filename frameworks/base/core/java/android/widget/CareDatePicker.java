...
import android.magcommutil.ThemeManager;
...
import android.widget.CareNumberPicker.OnValueChangeListener;
 ...
 * </p>
 * <p>
 * For a dialog using this view, see {@link android.app.CareDatePickerDialog}.
 * </p>
 *
 * @attr ref android.R.styleable#CareDatePicker_startYear
 * @attr ref android.R.styleable#CareDatePicker_endYear
 * @attr ref android.R.styleable#CareDatePicker_maxDate
 * @attr ref android.R.styleable#CareDatePicker_minDate
 * @attr ref android.R.styleable#CareDatePicker_spinnersShown
 * @attr ref android.R.styleable#CareDatePicker_calendarViewShown
 * @attr ref android.R.styleable#CareDatePicker_dayOfWeekBackground
 * @attr ref android.R.styleable#CareDatePicker_dayOfWeekTextAppearance
 * @attr ref android.R.styleable#CareDatePicker_headerBackground
 * @attr ref android.R.styleable#CareDatePicker_headerMonthTextAppearance
 * @attr ref android.R.styleable#CareDatePicker_headerDayOfMonthTextAppearance
 * @attr ref android.R.styleable#CareDatePicker_headerYearTextAppearance
 * @attr ref android.R.styleable#CareDatePicker_yearListItemTextAppearance
 * @attr ref android.R.styleable#CareDatePicker_yearListSelectorColor
 * @attr ref android.R.styleable#CareDatePicker_calendarTextColor
 * @attr ref android.R.styleable#CareDatePicker_datePickerMode
 */
@Widget
public class CareDatePicker extends FrameLayout {
    private static final String LOG_TAG = CareDatePicker.class.getSimpleName();
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(CareDatePicker view, int year, int monthOfYear, int dayOfMonth);
    }

    public CareDatePicker(Context context) {
        this(context, null);
    }

    public CareDatePicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.datePickerCareStyle);
    }

    public CareDatePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public CareDatePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
/*    private DatePickerDelegate createCalendarUIDelegate(Context context, AttributeSet attrs,
    ...
    /**
     * Gets the minimal date supported by this {@link CareDatePicker} in
    ...
    /**
     * Sets the minimal date supported by this {@link CareNumberPicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     *
    ...
    /**
     * Gets the maximal date supported by this {@link CareDatePicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     * <p>
    ...
    /**
     * Sets the maximal date supported by this {@link CareDatePicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     *
    ...
    abstract static class AbstractDatePickerDelegate implements DatePickerDelegate {
        // The delegator
        protected CareDatePicker mDelegator;
        ...
        public AbstractDatePickerDelegate(CareDatePicker delegator, Context context) {
    ...
    private static class DatePickerSpinnerDelegate extends AbstractDatePickerDelegate {
        ...
        private final CareNumberPicker mDaySpinner;

        private final CareNumberPicker mMonthSpinner;

        private final CareNumberPicker mYearSpinner;
        ...
        DatePickerSpinnerDelegate(CareDatePicker delegator, Context context, AttributeSet attrs,
                int defStyleAttr, int defStyleRes) {
            ...
            int layoutResourceId = attributesArray.getResourceId(
                    R.styleable.CareDatePicker_legacyLayout, R.layout.care_date_picker_legacy);
            ...
            OnValueChangeListener onChangeListener = new OnValueChangeListener() {
                public void onValueChange(CareNumberPicker picker, int oldVal, int newVal) {
                    updateInputState();
            ...
            /*begin: edit by hmq 20151126 Modify for 日期选择器根据launcher主题替换*/
            ThemeManager mThemeManager;
            ThemeManager.init(context); 
            mThemeManager = ThemeManager.getInstance();
            if(mThemeManager.getThemeType(context) == ThemeManager.THEME_CLASSICAL){
                mSpinners.setBackgroundResource(R.drawable.care_pick_bg_green);
            }else{
                mSpinners.setBackgroundResource(R.drawable.care_pick_bg_blue);
            }
            /*end: edit by hmq 20151126 Modify for 日期选择器根据launcher主题替换*/
            ...
            // day
            mDaySpinner = (CareNumberPicker) mDelegator.findViewById(R.id.day);
            mDaySpinner.setFormatter(CareNumberPicker.getTwoDigitFormatter());
            mDaySpinner.setOnLongPressUpdateInterval(100);
            mDaySpinner.setOnValueChangedListener(onChangeListener);
            mDaySpinnerInput = (EditText) mDaySpinner.findViewById(R.id.numberpicker_input);

            // month
            mMonthSpinner = (CareNumberPicker) mDelegator.findViewById(R.id.month);
            ...
            // year
            mYearSpinner = (CareNumberPicker) mDelegator.findViewById(R.id.year);
        ...
        @Override
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            event.setClassName(CareDatePicker.class.getName());
        }

        @Override
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            info.setClassName(CareDatePicker.class.getName());
        }
        ...
        protected void setCurrentLocale(Locale locale) {
            ...
            if (usingNumericMonths()) {
                ...
                // All-text would require custom CareNumberPicker formatters for day and year.
         ...
         */
        private void setImeOptions(CareNumberPicker spinner, int spinnerCount, int spinnerIndex) {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link CareDatePicker#onSaveInstanceState()}
         */
