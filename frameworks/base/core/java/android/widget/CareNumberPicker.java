 ...
 * </ul>
 * <p>
 * For an example of using this widget, see {@link android.widget.CareTimePicker}.
 * </p>
 */
@Widget
public class CareNumberPicker extends LinearLayout {
    ...
    /**
     * Use a custom CareNumberPicker formatting callback to use two-digit minutes
     * strings like "01". Keeping a static formatter etc. is the most efficient
     * way to do this; it avoids creating temporary objects on every call to
     * format().
     */
    private static class TwoDigitFormatter implements CareNumberPicker.Formatter {
    ...
    /**
     * Lower value of the range of numbers allowed for the CareNumberPicker
     */
    private int mMinValue;

    /**
     * Upper value of the range of numbers allowed for the CareNumberPicker
     */
    private int mMaxValue;

    /**
     * Current value of this CareNumberPicker
     */
    private int mValue;
     ...
     */
    private final Paint mSelectorWheelPaint;//选中字体画笔
    private final Paint mMiddleIndexPaint;//备选字体画笔
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(CareNumberPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(CareNumberPicker view, @ScrollState int scrollState);
    }
     ...
     */
    public CareNumberPicker(Context context) {
        this(context, null);
    }
     ...
     */
    public CareNumberPicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.numberPickerCareStyle);
    }
     ...
     */
    public CareNumberPicker(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public CareNumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);

        // process style attributes
        final TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.CareNumberPicker, defStyleAttr, defStyleRes);
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.CareNumberPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);
...
//        mSelectorWheelPaint = paint;
        ...
        /*备选字体形式*/
        float textSize = (float)(mTextSize*0.7);
        mMiddleIndexPaint = new Paint();
        mMiddleIndexPaint.setAntiAlias(true);
        mMiddleIndexPaint.setTextAlign(Align.CENTER);
        mMiddleIndexPaint.setTextSize(textSize);
        mMiddleIndexPaint.setTypeface(mInputText.getTypeface());
        ColorStateList colors = mInputText.getTextColors();
        int color = colors.getColorForState(ENABLED_STATE_SET, Color.WHITE);
        mMiddleIndexPaint.setColor(color);
     ...
     * <p>
     * If the argument is less than the {@link CareNumberPicker#getMinValue()} and
     * {@link CareNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link CareNumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link CareNumberPicker#getMinValue()} and
     * {@link CareNumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link CareNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link CareNumberPicker#getMaxValue()} and
     * {@link CareNumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link CareNumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link CareNumberPicker#getMinValue()} and
     * {@link CareNumberPicker#getMaxValue()} values.
     * <p>
...
//                canvas.drawText(scrollSelectorValue, x, y, mSelectorWheelPaint);//显示字的地方
//            }else{
//                canvas.drawText(scrollSelectorValue, x, y, mMiddleIndexPaint);
//            }
        ...
        // draw the selection dividers 显示上下线条的地方
...
//        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(CareNumberPicker.class.getName());
    ...
    /**
     * Sets the current value of this CareNumberPicker.
     *
     * @param current The new value of the CareNumberPicker.
    ...
    /**
     * Updates the view of this CareNumberPicker. If displayValues were specified in
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            CareNumberPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            CareNumberPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
        ...
        public void buttonTapped(int button) {
            ...
            mMode = MODE_TAPPED;
            mManagedButton = button;
            CareNumberPicker.this.post(this);
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                            	CareNumberPicker.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (CareNumberPicker.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (CareNumberPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (CareNumberPicker.this.isEnabled()) {
                            	CareNumberPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (CareNumberPicker.this.isEnabled()) {
                                ...
                                CareNumberPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setSource(CareNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(CareNumberPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setEnabled(CareNumberPicker.this.isEnabled());
                event.setSource(CareNumberPicker.this, virtualViewId);
                requestSendAccessibilityEvent(CareNumberPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText(
            ...
            info.setSource(CareNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(CareNumberPicker.this, virtualViewId);
            info.setParent(CareNumberPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(CareNumberPicker.this.isEnabled());
            Rect boundsInParent = mTempRect;
            boundsInParent.set(left, top, right, bottom);
            info.setVisibleToUser(isVisibleToUser(boundsInParent));
            info.setBoundsInParent(boundsInParent);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(CareNumberPicker.class.getName());
            info.setPackageName(mContext.getPackageName());
            info.setSource(CareNumberPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(CareNumberPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(CareNumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(CareNumberPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
