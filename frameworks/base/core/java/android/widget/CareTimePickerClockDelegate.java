...
/**
 * A delegate implementing the radial clock-based CareTimePicker.
 */
class CareTimePickerClockDelegate extends CareTimePicker.AbstractTimePickerDelegate implements
        RadialTimePickerView.OnValueSelectedListener {

    private static final String TAG = "CareTimePickerClockDelegate";
    ...
    // LayoutLib relies on these constants. Change CareTimePickerClockDelegate_Delegate if
    // modifying these.
    ...
    public CareTimePickerClockDelegate(CareTimePicker delegator, Context context, AttributeSet attrs,
    ...
    @Override
    public void setOnTimeChangedListener(CareTimePicker.OnTimeChangedListener callback) {
