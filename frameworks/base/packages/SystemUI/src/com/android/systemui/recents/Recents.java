...
public class Recents extends SystemUI
    ...
    class TaskStackListenerImpl extends ITaskStackListener.Stub implements Runnable {
        ...
        public void run() {
            ...
            if (config.svelteLevel == RecentsConfiguration.SVELTE_NONE) {
                ...
                launchOpts.loadThumbnails = false;//modify by even :fix get Thumbnails OOM bug 1211
    ...
    public void start() {
        ...
        if (mSystemServicesProxy.isForegroundUserOwner()) {
            ...
            if(isTablet){           
                mContext.getApplicationContext().registerReceiverAsUser(mProxyBroadcastReceiver, UserHandle.CURRENT, filter,
                        null, mHandler);
            }else{              
