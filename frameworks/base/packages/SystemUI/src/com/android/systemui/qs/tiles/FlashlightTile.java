...
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        //final AnimationIcon icon = state.value ? mEnable : mDisable;//hmq
        //icon.setAllowAnimation(arg instanceof UserBoolean && ((UserBoolean) arg).userInitiated);//hmq
        //state.icon = icon;//hmq
        state.icon = state.value ? ResourceIcon.get(R.drawable.ic_signal_flashlight_enable) : ResourceIcon.get(R.drawable.ic_signal_flashlight_disable);//hmq
