...
public class LocationTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleClick() {
        ...
        //mEnable.setAllowAnimation(true);//hmq
        //mDisable.setAllowAnimation(true);//hmq
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (locationEnabled) {
            //state.icon = mEnable;//hmq
            state.icon = ResourceIcon.get(R.drawable.ic_signal_location_enable);//hmq
            state.label = mContext.getString(R.string.quick_settings_location_label);
            state.contentDescription = mContext.getString(
                    R.string.accessibility_quick_settings_location_on);
        } else {
            //state.icon = mDisable;//hmq
            state.icon = ResourceIcon.get(R.drawable.ic_signal_location_disable);//hmq
            state.label = mContext.getString(R.string.quick_settings_location_label);
            state.contentDescription = mContext.getString(
