...
public abstract class PanelView extends FrameLayout {
    ...
    private boolean mTouchDown;//bug:: longclick unlock screen status bar expanded by hmq
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN) {
            ...
            mTouchDown = true;//bug:: longclick unlock screen status bar expanded by hmq
        }
        boolean waitForTouchSlop = hasConflictingGestures() || mGestureWaitForTouchSlop;//edit by hmq 20160504状态栏分2页显示
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                /* begin: edit by hmq 20160504状态栏分2页显示 */
                if(waitForTouchSlop){
                    setNotificationWhichPage();
                }
                /* end: edit by hmq 20160504状态栏分2页显示 */
                break;

            case MotionEvent.ACTION_POINTER_UP:
                if (!mTouchDown){//bug:: longclick unlock screen status bar expanded by hmq
                    return false;
                }
    ...
    protected abstract void setNotificationWhichPage();//edit by hmq 20160504状态栏分2页显示
}
