...
public class QSTileView extends ViewGroup {
    ...
    private void recreateLabel() {
        ...
        if (mDual) {// edit by hmq 20151025 Modify for 老人机下拉状态栏[宫格图标下面一栏 有扩展 字体+向下的箭头]
            mDualLabel = new QSDualTileLabel(mContext);
            mDualLabel.setId(View.generateViewId());
            //mDualLabel.setBackgroundResource(R.drawable.btn_borderless_rect);// edit by hmq 20151025 Modify for 老人机下拉状态栏
            mDualLabel.setFirstLineCaret(mContext.getDrawable(R.drawable.qs_dual_tile_caret));//三角箭头
            mDualLabel.setTextColor(mContext.getColor(R.color.qs_tile_text));
            //mDualLabel.setPadding(0, mDualTileVerticalPaddingPx, 0, mDualTileVerticalPaddingPx);// edit by hmq 20151025 Modify for 老人机下拉状态栏
            mDualLabel.setPadding(0, 0, 0, 0);// edit by hmq 20151025 Modify for 老人机下拉状态栏[间隔]
        ...
        } else {// edit by hmq 20151025 Modify for 老人机下拉状态栏[宫格图标下面一栏 无扩展 字体]
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        /* begin: edit by hmq 20151025 Modify for 老人机下拉状态栏[宫格图标下面一栏 有扩展 去除白线]
        if (mDual) {
