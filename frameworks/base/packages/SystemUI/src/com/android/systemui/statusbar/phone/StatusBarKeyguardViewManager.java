...
public class StatusBarKeyguardViewManager {
    ...
    public void dismiss(boolean authenticated) {
        ...
        if (mDeviceInteractive || VoiceWakeupManager.getInstance().isDismissAndLaunchApp()) {
            ...
            if (isMagcommLockerShowing() && isSecure()) {
                mPhoneStatusBar.hideKeyguard();
                mViewMediatorCallback.setMagcommLockerShowing(false);
            }
    ...
    /*
     * @return Whether the magcommlocker is showing
     */
    public boolean isMagcommLockerShowing() {
        return mViewMediatorCallback.isMagcommLockerShowing();
    }
