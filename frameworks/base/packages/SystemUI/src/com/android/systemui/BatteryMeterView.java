...
/*
 * edit by hmq 20140915 Modify for 电池以图标显示
 * 添加资源
 * stat_sys_battery_0.png    stat_sys_battery_15.png    stat_sys_battery_28.png    stat_sys_battery_43.png
 * stat_sys_battery_57.png    stat_sys_battery_71.png    stat_sys_battery_85.png    stat_sys_battery_100.png
 * stat_sys_battery_charge_anim0.png    stat_sys_battery_charge_anim15.png    stat_sys_battery_charge_anim28.png    stat_sys_battery_charge_anim43.png
 * stat_sys_battery_charge_anim57.png    stat_sys_battery_charge_anim71.png    stat_sys_battery_charge_anim85.png    stat_sys_battery_charge_anim100.png
 * stat_sys_battery.xml    stat_sys_battery_charge.xml
 */
public class BatteryMeterView extends ImageView implements DemoMode,/* edit by hmq 20140915 Modify for 电池以图标显示 View To ImageView */
    ...
    private ImageView mBatteryImg;// edit by hmq 20140915 Modify for 电池以图标显示
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBatteryImg = this;// edit by hmq 20140915 Modify for 电池以图标显示
    ...
    public void draw(Canvas c) {
        super.draw(c);
        /* edit by hmq 20140915 Modify for 电池以图标显示 hide code
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                level = (int)(100f
                        * intent.getIntExtra(BatteryManager.EXTRA_LEVEL, 0)
                        / intent.getIntExtra(BatteryManager.EXTRA_SCALE, 100));//电量百分比

                plugType = intent.getIntExtra(BatteryManager.EXTRA_PLUGGED, 0);//插入类型
                plugged = plugType != 0;
                ...
                /* begin: edit by hmq 20140915 Modify for 电池以图标显示 */
                if (plugged) {
                    final int icon = R.drawable.stat_sys_battery_charge;
                    mBatteryImg.setImageResource(icon);
                    mBatteryImg.setImageLevel(level);
                } else {
                    final int icon = R.drawable.stat_sys_battery;
                    mBatteryImg.setImageResource(icon);
                    mBatteryImg.setImageLevel(level);
                }
                //postInvalidate();
                /* end: edit by hmq 20140915 Modify for 电池以图标显示 */
