...
public class QSPanel extends ViewGroup {
    private static final float TILE_ASPECT = 0.8f;// edit by hmq 20151025 Modify for 老人机下拉状态栏[宽度与高度的转换系数]<1.2f>

    private final Context mContext;
    protected final ArrayList<TileRecord> mRecords = new ArrayList<TileRecord>();//notification content eg: 蓝牙， wifi, sim card
    private final View mDetail;
    private final ViewGroup mDetailContent;
    private final TextView mDetailSettingsButton;
    private final TextView mDetailDoneButton;
    protected final View mBrightnessView;//notification content brightness
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (TileRecord record : mRecords) {
            ...
            if (r == -1 || c == (mColumns - 1) /*|| rowIsDual != record.tile.supportsDualTargets()*/) {// edit by hmq 20151025 Modify for 老人机下拉状态栏
                r++;
                c = 0;
        ...
        int h = rows == 0 ? brightnessHeight : brightnessHeight + (getRowTop(rows) + mPanelPaddingBottom);// edit by hmq 20151025 Modify for 老人机下拉状态栏
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        /* edit by hmq 20151025 Modify for 老人机下拉状态栏
        ...
        */
        ...
        int tileView_height = 0;// edit by hmq 20151025 Modify for 老人机下拉状态栏
        for (TileRecord record : mRecords) {
            if (record.tileView.getVisibility() == GONE) continue;
            ...
            tileView_height = top + record.tileView.getMeasuredHeight();// edit by hmq 20151025 Modify for 老人机下拉状态栏
            record.tileView.layout(left, top, right, top + record.tileView.getMeasuredHeight());
        }
        /* begin: edit by hmq 20151025 Modify for 老人机下拉状态栏 */
        mBrightnessView.layout(0, mBrightnessPaddingTop + tileView_height,
                mBrightnessView.getMeasuredWidth(),
                mBrightnessPaddingTop + tileView_height + mBrightnessView.getMeasuredHeight());
