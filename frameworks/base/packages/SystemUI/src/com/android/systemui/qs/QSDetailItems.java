...
public class QSDetailItems extends FrameLayout {
    ...
    public void setEmptyState(int icon, int text) {
        ...
        mEmptyText.setTextColor(mContext.getResources().getColor(R.color.qs_detail_item_first_text_color));// edit by hmq 20151025 Modify for 老人机下拉状态栏
    }
    ...
    private void bind(final Item item, View view) {
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.qs_detail_item, this, false);//hmq [列表内容布局]
            mItems.addView(view);
        }
