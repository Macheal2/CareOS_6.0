...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    private boolean mShowSystemLockNotifications = false;//added by yzs for MagcommLocker
    ...
    protected void setShowLockscreenNotifications(boolean show) {
        ...
        if (mStatusBarKeyguardViewManager != null 
                && mStatusBarKeyguardViewManager.isMagcommLockerShowing()){
            mShowLockscreenNotifications = show;
        }else {
            mShowLockscreenNotifications = mShowSystemLockNotifications;
        }
    ...
    private void updateLockscreenNotificationSetting() {
        ...
        //added by yzs for MagcommLocker begin
        mShowSystemLockNotifications =  show && allowedByDpm;
        //added by yzs for MagcommLocker end
    ...
    protected boolean shouldInterrupt(Entry entry, StatusBarNotification sbn) {
        ...
        boolean interrupt = (isFullscreen || (isHighPriority && (isNoisy || hasTicker)))
				//caiji add for Care_OS incoming call full screen start
                && (!sbn.getPackageName().equals("com.android.dialer"))
				&& (!sbn.getPackageName().equals("com.android.deskclock"))
				//caiji add for Care_OS incoming call full screen end
                && isAllowed
