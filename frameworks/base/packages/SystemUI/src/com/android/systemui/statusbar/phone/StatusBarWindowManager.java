...
public class StatusBarWindowManager {
    ...
    private void applyKeyguardFlags(State state) {
        if (state.keyguardShowing) {
            ...
            if ((mStatusBarView != null && mStatusBarView instanceof StatusBarWindowView)) {
                if ((((StatusBarWindowView) mStatusBarView).getCappuLockerView() != null) || (((StatusBarWindowView) mStatusBarView).getMagcommLockerView() != null)) {
...
//            // added by yzs for MagcommLocker end
    ...
    private void applyFocusableFlag(State state) {
        //added by yzs for MagcommLocker begin
        if (state.isKeyguardShowingAndNotOccluded() 
            && (mStatusBarView != null && mStatusBarView instanceof StatusBarWindowView)){
            if ((((StatusBarWindowView)mStatusBarView).getCappuLockerView() != null)||
                (((StatusBarWindowView)mStatusBarView).getMagcommLockerView() != null)){
