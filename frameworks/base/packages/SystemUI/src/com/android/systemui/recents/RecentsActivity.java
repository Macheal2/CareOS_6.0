...
public class RecentsActivity extends Activity implements RecentsView.RecentsViewCallbacks,
    ...
    private ArrayList<TaskStack> stacks = null;
    /**songkun@20150711 end*/
    ...
    void updateRecentsTasks() {
        ...
        /*ArrayList<TaskStack>*/ stacks = plan.getAllTaskStacks();//songkun@20150711
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        roateImageView = (ImageView) findViewById(R.id.clean_icon);
        /**songkun@20150711 end*/	
    }
    ...
    protected void onStart() {
        ...
        mClearBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(roateImageView!=null){
                    roateImageView.startAnimation(AnimationUtils.loadAnimation(RecentsActivity.this, R.anim.recents_rotate_anim));
                }
                clearAllTask();						
        ...
        mClearBtn.setOnLongClickListener(new OnLongClickListener(){
    ...
    public static boolean isOneKeyCleanSupported() {
        boolean enable = SystemProperties.getInt("ro.one_key_clean", 0) == 1 ? true : false;
        Log.i(TAG, "isOneKeyCleanSupported() return: " + enable);
