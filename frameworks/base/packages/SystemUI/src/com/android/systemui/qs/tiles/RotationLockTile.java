...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.visible = true;//mController.isRotationLockAffordanceVisible();//edit by hmq 永远显示横竖屏图标，不受无障碍开关影响
        ...
        //icon.setAllowAnimation(userInitiated);//hmq
        //state.icon = icon;//hmq
        state.icon = rotationLocked ? ResourceIcon.get(R.drawable.ic_portrait_to_auto_rotate) : ResourceIcon.get(R.drawable.ic_portrait_from_auto_rotate);//hmq
