...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
			...
			//zhaogangzhu@20150919 dataconn secretcode begin
            loadIntegerSetting(stmt, "enable_data_conn_secretcode", R.integer.def_enable_data_conn_secretcode);
            loadStringSetting(stmt, "data_conn_secretcode",R.string.def_data_conn_secretcode);
            //zhaogangzhu@20150919 dataconn secretcode end
           ...
           //modify by even hejianfeng@20150601hall menu
            if (!SystemProperties.get("ro.magcomm_hall_support").equals("1")) {
                loadSetting(stmt, Settings.System.HALL_SETTING,0);
            }else{
            	loadIntegerSetting(stmt, Settings.System.HALL_SETTING,
            			R.integer.def_hall_setting);
            }
			loadBooleanSetting(stmt, Settings.System.HALL_CLOSE,
                    R.bool.def_hall_close);
			//modify by even hejianfeng@20150601 hall end

			//hejianfeng add start for default iflytek
			loadStringSetting(stmt, "speech_tools_key",
                    R.string.def_iflytek_informant);
			//hejianfeng add end
            ...
            loadSetting(stmt, Settings.Global.MOBILE_DATA,
                    ...
                    SystemProperties.get("ro.mtk_gemini_support").equals("1") ? 0 : 0));//modified by Yar @20170809 default (* ? 0 : 1)
