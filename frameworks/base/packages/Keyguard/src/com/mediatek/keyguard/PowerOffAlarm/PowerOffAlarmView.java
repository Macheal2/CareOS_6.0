...
public class PowerOffAlarmView extends RelativeLayout implements
    ...
    private Button mSnoozeView,mDismissOffView,mDismissOnView;//dengjiazhang@20150706 add start
    ...
    protected void onFinishInflate() {
        ...
        triggerPing();
// zhouhua@20170819 add  powerOff Alarm clock interface   start
        mSnoozeView = (Button)findViewById(R.id.snooze);
        mSnoozeView.setOnClickListener(new View.OnClickListener(){
        ...
        mDismissOffView = (Button)findViewById(R.id.dismiss_pwroff);
        mDismissOffView.setOnClickListener(new View.OnClickListener(){
        ...
        mDismissOnView = (Button)findViewById(R.id.dismiss_pwron);
        mDismissOnView.setOnClickListener(new View.OnClickListener(){
...
// zhouhua@20170819 add  powerOff Alarm clock interface end
    ...
    //modify by even
    public static final String ACTION_REBOOT_EVEN =  "com.android.deskclock.ALARM.need.reboot";
