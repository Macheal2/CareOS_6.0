...
public abstract class KeyguardPinBasedInputView extends KeyguardAbsKeyInputView
        implements View.OnKeyListener , OnTouchListener{
//dengjianzhang@20150706 add end 
    ...
    private ViewGroup mKeyguardBouncerFrame;//dengjianzhang@20150706 add start
    ...
    protected void onFinishInflate() {
        ...
        mKeyguardBouncerFrame.setOnTouchListener(this);
        //dengjianzhang@20150706 add end
