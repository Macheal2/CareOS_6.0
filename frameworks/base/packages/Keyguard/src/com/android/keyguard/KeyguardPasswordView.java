            ...
            public void afterTextChanged(Editable s) {
                if (mCallback != null) {
                    ...
                    post(new Runnable() {
                        @Override
                        public void run() {
                            android.util.Log.i("liukun", "mPasswordEntry = " + mPasswordEntry.getText().toString());
                            android.util.Log.i("liukun", "length = " + mPasswordEntry.getText().toString().length());
                            android.util.Log.i("liukun", "get length = " + Settings.System.getInt(mContext1.getContentResolver(),"pin_length",0));
                            if(mPasswordEntry.getText().toString().length() == Settings.System.getInt(mContext1.getContentResolver(),"pin_length",0)){
