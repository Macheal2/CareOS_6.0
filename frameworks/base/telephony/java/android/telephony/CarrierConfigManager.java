...
public class CarrierConfigManager {
    ...
    */
    ...
    static {
        ...
        sDefaults.putBoolean(KEY_HIDE_SIM_LOCK_SETTINGS_BOOL, true);//隐藏Sim卡锁定方式菜单
        ...
        /* Deafult value is in sync with ImsConfig.WfcModeFeatureValueConstants.WIFI_PREFERRED*/
