...
cappu-res-source-path := APPS/cappu-res_intermediates/src
...
#add by y.haiyang for cappu res (start)
LOCAL_INTERMEDIATE_SOURCES += \
            $(cappu-res-source-path)/com/cappu/internal/R.java \
            $(cappu-res-source-path)/com/cappu/R.java \
            $(cappu-res-source-path)/com/cappu/Manifest.java
#add by y.haiyang for cappu res (end)
...
$(full_classes_compiled_jar): $(cappu_res_R_stamp)
$(built_dex_intermediate): $(cappu_res_R_stamp)
# @}
