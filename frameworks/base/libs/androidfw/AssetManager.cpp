...
static const char* kCappuAssets = "framework/cappu-res/cappu-res.apk";
...
const char* AssetManager::MEDIATEK_TARGET_APK_PATH = "/system/framework/mediatek-res/mediatek-res.apk";
