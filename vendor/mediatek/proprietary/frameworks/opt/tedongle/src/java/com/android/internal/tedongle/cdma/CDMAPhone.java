...
import android.tedongle.cdma.CdmaCellLocation;
...
import com.android.internal.tedongle.SubscriptionController;
...
import com.android.internal.tedongle.uicc.IccException;
...
public class CDMAPhone extends PhoneBase {
    static final String LOG_TAG = "3GD-CDMAPhone";
    ...
    public String getVoiceMailNumber() {
        ...
        if (TextUtils.isEmpty(number)) {
            ...
            if (getContext().getResources().getBoolean(com.android.internal
                ...
                number = "*86";//modified by Yar @20170815
            }
        }
        return number;
    }
    ...
    public void handleMessage(Message msg) {
        ...
        switch(msg.what) {
            ...
            case EVENT_GET_BASEBAND_VERSION_DONE:{
                ...
                TelephonyManager.getDefault().setBasebandVersionForPhone(getPhoneId(),
                        (String)ar.result);
            }
            break;
...
//                }
    ...
    public boolean setOperatorBrandOverride(String brand) {
        ...
        if (status) {
            ...
            if (iccRecords != null) {
                TelephonyManager.getDefault().setSimOperatorNameForPhone(
