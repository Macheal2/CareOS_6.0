...
//    private TextView mActionBarText;
    ...
    private Button bnForward = null;
    private String mTitleText = null;
    //private static VivoStyleDialog mDeleteMessageDialog;
    //@
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setUpActionBar(); del by songkun for care
    ...
    private void vivoInit(){
        ...
        //bnLeft.setText(R.string.select_all);//added by yzs
        //bnLeft.setImageDrawable(MmsConfig.mImageResourceBack);
        ...
        //bnRight.setImageDrawable(MmsConfig.mImageResourceSelect);
        ...
        bnLeft.setOnClickListener(new android.view.View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
        ...
        bnForward = (Button)findViewById(R.id.bnForward);
        bnForward.setEnabled(false);
        bnForward.setOnClickListener(new android.view.View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
...
*/
	...
	*/
    ...
    private void confirmMultiDeleteMsgDialog(final MultiDeleteMsgListener listener,
	    ...
	    //modified by yzs for I99 UI
	    String message = null;
        msg.setTextSize(29);
        msg.setGravity(Gravity.CENTER);
        if (!deleteThread) {
            // modify by bruce for vivo style
            if (true){
                int selectNum = getSelectedCount();
                msg.setText(context.getResources().getQuantityString(
                    R.plurals.vivo_confirm_delete_message, selectNum, selectNum));
	        message = context.getResources().getQuantityString(R.plurals.vivo_confirm_delete_message, selectNum, selectNum);//added by yzs
            }else {
                msg.setText(getString(R.string.confirm_delete_selected_messages));
		message = getString(R.string.confirm_delete_selected_messages);//added by yzs 
            }
        } else {
            ...
            if (threadIds == null) {
		        ...
		        message = getString(R.string.confirm_delete_all_conversations);//added by yzs
            } else {
                // Show the number of threads getting deleted in the confirmation dialog.
                msg.setText(context.getResources().getQuantityString(
                    R.plurals.confirm_delete_conversation, 1, 1));
		message = context.getResources().getQuantityString(R.plurals.confirm_delete_conversation, 1, 1);//added by yzs
            }
        }
        ...
        */
        ...
        builder.setTitle(R.string.confirm_dialog_title).setIconAttribute(
            android.R.attr.alertDialogIcon).setCancelable(true).setPositiveButton(R.string.yes,
            listener).setNegativeButton(R.string.no, null).setView(contents).show();
    }

    private class MultiDeleteMsgListener implements OnClickListener, android.view.View.OnClickListener{
...
//                                            .deleteIpMsg(ids, false);//songkun mod
...
//                        }
    ...
    private void updateSelectCount() {
        ...
        if (selectNum > 0){
            ...
            String forward = getString(R.string.menu_forward);
            bnDelete.setText(delete + "(" + selectNum + ")");
            bnDelete.setEnabled(true);
            bnForward.setText(forward + "(" + selectNum + ")");
            bnForward.setEnabled(true);
            if (selectNum < mMsgListAdapter.getCount()){
            ...
            mTopBar.setRightDrawable(MmsConfig.mImageResourceSelect);
			//bnRight.setImageDrawable(MmsConfig.mImageResourceSelect);//yzs        
            //bnLeft.setText(R.string.select_all);//yzs
            //bnRight.setImageDrawable(MmsConfig.mImageResourceSelect);
            bnDelete.setText(R.string.delete);
            bnDelete.setEnabled(false);
            bnForward.setText(R.string.menu_forward);
            bnForward.setEnabled(false);
        }
        // add by bruce for vivo style end
/*    del by yzs
...
//            R.plurals.message_view_selected_message_count, selectNum, selectNum));
    ...
    private class SelectActionMode implements ActionMode.Callback {
        ...
        private void showMmsTipsDialog(final ActionMode mode, final MenuItem item) {
            CareDialog.Builder builder = new CareDialog.Builder(MultiDeleteActivity.this);
    ...
    public void prepareToForwardMessage() {
        ...
        if (mHasMms && !mMmsNotificationHasRun) {
            if (getSelectedCount() == 1) {
               ...
               new CareDialog.Builder(MultiDeleteActivity.this)
