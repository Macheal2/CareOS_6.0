...
public class AttachmentTypeSelectorAdapter extends IconListAdapter {
    ...
    //public final static int TAKE_PICTURE            = 1;//songkun: rm for care
    public final static int ADD_VIDEO               = 2;
    //public final static int RECORD_VIDEO            = 3;//songkun: rm for care
    public final static int ADD_SOUND               = 4;
    //public final static int RECORD_SOUND            = 5;//songkun: rm for care
    //public final static int ADD_SLIDESHOW           = 6;//songkun: rm for care
    ...
    //public static final int ADD_VCALENDAR           = 8;//songkun: rm for care
