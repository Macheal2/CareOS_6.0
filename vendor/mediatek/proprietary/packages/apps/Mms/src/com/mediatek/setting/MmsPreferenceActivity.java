...
public class MmsPreferenceActivity extends PreferenceActivity
    ...
    // add by songkun for care begin
    private void initVivo(){
        setContentView(R.layout.smspreference_activity);

        mTopBar = (TopBar) findViewById(R.id.topbar);
        mTopBar.setText(R.string.pref_setting_mms);
        mTopBar.setOnTopBarListener(new TopBar.onTopBarListener(){
            @Override
            public void onLeftClick(View v){
                MmsPreferenceActivity.this.finish(); 
            }
    
            @Override
            public void onRightClick(View v){
                CareDialog.Builder builder = new CareDialog.Builder(MmsPreferenceActivity.this);
