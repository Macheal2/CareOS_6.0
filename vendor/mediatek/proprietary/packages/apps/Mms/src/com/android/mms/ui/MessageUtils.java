...
/* Cappu:lau on: Mon, 14 Aug 2017 15:17:58 +0800
 * TODO: 在MMS发送界面点击查看直接跳转到相册
 */
            ComponentName component = new ComponentName("com.android.gallery3d", "com.android.gallery3d.app.GalleryActivity");
...
//          handler.postDelayed(showProgress, 1000);
    ...
    public static void showDiscardDraftConfirmDialog(Context context,
        ...
        new CareDialog.Builder(context)
...
//                    launchSlideshowActivity(activity, msgUri, requestCode);
    ...
    public static void addNumberOrEmailtoContact(final String numberOrEmail, final int REQUEST_CODE,
        ...
        if (!TextUtils.isEmpty(numberOrEmail)) {
            ...
            //modified by yzs from AlertDialog to CareDialog
            CareDialog.Builder builder = new CareDialog.Builder(activity).setTitle(numberOrEmail).setMessage(message);
            CareDialog dialog = builder.create();
            dialog.setButton(CareDialog.BUTTON_POSITIVE, activity.getResources().getString(
            ...
            dialog.setButton(CareDialog.BUTTON_NEGATIVE, activity.getResources()
    ...
    public static void confirmDeleteMessage(final Activity activity, final Uri msgUri) {
        //modified by yzs from AlertDialog to CareDialog
        CareDialog.Builder builder = new CareDialog.Builder(activity);
        builder.setTitle(R.string.confirm_dialog_title);
        builder.setIconAttribute(android.R.attr.alertDialogIcon);
        builder.setCancelable(true);
        builder.setMessage(R.string.confirm_delete_message);
        builder.setPositiveButton(R.string.i99_dialog_right,
...
//        final long totalBlocks = stat.getBlockCount();
    ...
    public static CharSequence getStatusStringId(Context context, MessageItem msgItem) {
        SpannableStringBuilder mSpannableStringBuilder = null;//new SpannableStringBuilder(str);
        String str = null;

        if (msgItem == null) {
            MmsLog.e("songkun", "getStatusResourceId(): MsgItem is null!", new Exception());
            return "";
        }
        if (msgItem.isSubMsg()) {
            MmsLog.d("songkun", "getStatusResourceId(): SIM message.");
            return "";
        }
        MmsLog.d("songkun", "getStatusResourceId(): MsgId = " + msgItem.mMsgId);
        MmsLog.d("songkun", "getStatusResourceId(): isMms = " + msgItem.isMms()
			+ ", isSms = " + msgItem.isSms()
            + ", SENTBOX = " + (msgItem.mBoxId == Mms.MESSAGE_BOX_SENT)
            + ", has read report = " + msgItem.mHasReadReport
            + ", has delivery report = " + msgItem.mHasDeliveryReport);
        if (!msgItem.isMms()) {
            if (msgItem.mHasReadReport) {
                str = context.getResources().getString(R.string.i99_send_read);
                mSpannableStringBuilder = new SpannableStringBuilder(str);
                mSpannableStringBuilder.setSpan(new ForegroundColorSpan(Color.BLACK), 0, str.length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);

                //return R.drawable.im_meg_status_read;
            }
            if (msgItem.mHasDeliveryReport) {
                str = context.getResources().getString(R.string.i99_send_success);
                mSpannableStringBuilder = new SpannableStringBuilder(str);
                mSpannableStringBuilder.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.i99_color_send_success)), 0, str.length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
                //return R.drawable.im_meg_status_reach;
            }
            ...
            case Mms.MESSAGE_BOX_SENT:
				...
				break;
            case Mms.MESSAGE_BOX_OUTBOX:
                str = context.getResources().getString(R.string.i99_sending);
                mSpannableStringBuilder = new SpannableStringBuilder(str);
                mSpannableStringBuilder.setSpan(new ForegroundColorSpan(Color.YELLOW), 0, str.length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
                //return R.string.i99_sending;
                //return R.drawable.im_meg_status_sending;
				break;
            case Mms.MESSAGE_BOX_INBOX:
            case Mms.MESSAGE_BOX_DRAFTS:
            ...
            case Sms.MESSAGE_TYPE_OUTBOX:
                ...
                //return R.drawable.im_meg_status_sending;
				break;
            case Sms.MESSAGE_TYPE_SENT:str = context.getResources().getString(R.string.i99_send_success);
                mSpannableStringBuilder = new SpannableStringBuilder(str);
                mSpannableStringBuilder.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.i99_color_send_success)), 0, str.length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
                
                //return R.string.i99_send_success;
                //return R.drawable.im_meg_status_out;
				break;
            case Sms.MESSAGE_TYPE_FAILED:
                ///M: this status has been handled by common flow
