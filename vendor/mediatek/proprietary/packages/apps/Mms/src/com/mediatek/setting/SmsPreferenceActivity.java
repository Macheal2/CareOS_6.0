...
import android.widget.ImageButton;//songkun
...
public class SmsPreferenceActivity extends PreferenceActivity implements
	...
	*/
    ...
    private void initVivo(){
        ...
        mTopBar.setText(R.string.pref_setting_sms);
        mTopBar.setOnTopBarListener(new TopBar.onTopBarListener(){
            @Override
            public void onLeftClick(View v){
                SmsPreferenceActivity.this.finish(); 
            }
    
            @Override
            public void onRightClick(View v){
                CareDialog.Builder builder = new CareDialog.Builder(SmsPreferenceActivity.this);
