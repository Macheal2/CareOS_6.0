...
// songkun for care @
    private static boolean mSelecteStatus = false;
    public static final int SENDMESSAGE_ACTIVITY_STYLE_NEW = 0x001;
    public static final int SENDMESSAGE_ACTIVITY_STYLE_REPLY = 0x002;
    private static String mNumber = null;
    private static String mTitle = null;
    public static Drawable mImageResourceEdit = null;//getResources().getDrawable(R.drawable.i99_title_bt_edit);
    public static Drawable mImageResourceBack = null;//getResources().getDrawable(R.drawable.i99_title_bt_back);
    public static Drawable mImageResourceSelect = null;//getResources().getDrawable(R.drawable.i99_title_bt_select);
    public static Drawable mImageResourceUnselect = null;//getResources().getDrawable(R.draw
    public static Drawable mImageResourceRestore = null;//getResources().getDrawable(R.draw
    // songkun @
   
    public static boolean getSelectStatus(){
        return mSelecteStatus;
    }
    public static void setSelectStatus(boolean selected){
        mSelecteStatus = selected;
    }
	...
	mImageResourceSelect = context.getResources().getDrawable(R.drawable.i99_title_bt_select);
        mImageResourceUnselect = context.getResources().getDrawable(R.drawable.i99_title_bt_unselect);       
...
//    }
   ...
   /* private static void loadSimInfo(Context context) {
    ...
    public static void actionCallDial(Context context,String number){
         Intent intentAction = new Intent();
         intentAction.setAction("android.intent.action.CALL");
         intentAction.setData(Uri.parse("tel:" + number));
         context.startActivity(intentAction);
    }
  
    public static void viewContactDetail(Context context, String number){
	 final Intent intent = new Intent(Intent.ACTION_VIEW, getLookupUri(context, number));
	 intent.putExtra(Insert.PHONE, number);
	 context.startActivity(intent);
    }
	...
	public static boolean getMessageSpeechState(Context context){
		Context _context = null;
		int state = Settings.Global.getInt(context.getContentResolver(), "mms_speech_status", 0);
