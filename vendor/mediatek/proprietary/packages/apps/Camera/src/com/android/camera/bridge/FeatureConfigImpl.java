...
public class FeatureConfigImpl implements IFeatureConfig {
    ...
    @Override
    public boolean isShutterSoundSupport() {
    	return FeatureSwitcher.isShutterSoundEnable();
    }
    
    @Override
    public boolean isTimeStampSupport() {
    	return FeatureSwitcher.isTimeStampSupport();
    }
    /**dengjianzhang@20150611 end*/

    // added by bruce for touch photograph begin
    @Override
    public boolean isTouchPhotographSupport() {
    	return FeatureSwitcher.isTouchPhotographEnable();
    }
