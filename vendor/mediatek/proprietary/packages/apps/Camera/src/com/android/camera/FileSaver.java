...
public class FileSaver {
    ...
    private class PhotoOperator extends RequestOperator {
        ...
        public synchronized void saveRequest() {
            ...
            /**dengjianzhang@20150709 start*/
            boolean mTimeStampEnable="on".equals(mContext.getISettingCtrl().getSettingValue(SettingConstants.KEY_CAMERA_TIME_STAMP));
                   
            if(FeatureSwitcher.isTimeStampSupport()&&mTimeStampEnable){
            	try {
        ...
        public Thumbnail createThumbnail(int thumbnailWidth) {
            ...
            if (mUri != null && mData != null) {
                ...
                Settings.Global.putString(mContentResolver, "jeff_current_picture_name", mFileName);//hejianfeng add
            }
    ...
    public Bitmap createBitmap(Bitmap src, long dateTaken) {
    	  ...
    	  canvas.drawText(datetime, (w-p.measureText(datetime)), (h-textSize), p);
