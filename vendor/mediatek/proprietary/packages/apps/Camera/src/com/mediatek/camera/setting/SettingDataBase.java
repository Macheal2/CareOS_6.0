...
//        video   videopip   smile     gesture   refecous
 ...
 MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY]    = new int[]{
		...
		MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND]  = new int[]{STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_D0,  STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_D0};//dengjianzhang@20150611
		MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH]  = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,  STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0};// added by bruce for touch photograph
		MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_TIME_STAMP]  = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_E0, STATE_R0,  STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0};//dengjianzhang@20150709
    }
    ...
    static {
        ...
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_VOICE]                = new String[]{"off", "on"};// {"off"};off dengjianzhang@20150907
        ...
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_DNG] = new String[]{"off", "on"};
	 	RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND] = new String[]{"off", "on"};//dengjianzhang@20150611
	 	RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_TIME_STAMP]    = new String[]{"off", "on"};//dengjianzhang@20150709 time stamp
	 	RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH] = new String[]{"off", "on"};// added by bruce for touch photograph
    }
    ...
    static {
        ...
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND]  = R.string.pref_camera_shutter_sound_default;//dengjianzhang@20150611
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_TIME_STAMP]     = R.string.pref_camera_time_stamp_default;//dengjianzhang@20150709
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH]  = R.string.pref_camera_touch_photograph_default;// added by bruce for touch photograph
    }
