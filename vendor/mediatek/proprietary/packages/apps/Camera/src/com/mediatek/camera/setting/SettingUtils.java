...
public class SettingUtils {
    ...
    public static void initialCameraPictureSize(Context context, Parameters parameters,
        ...
        if (supportedRatios != null && supportedRatios.size() > 0) {
            SharedPreferences.Editor editor = sharedPreferences.edit();
            //modify camera 4:3 by lixiang 20161013
    ...
    public static void restorePreferences(Context context, SharedPreferences sharedPreferences,
        ...
        String voiceValue = sharedPreferences.getString(SettingConstants.KEY_VOICE, "off");//dengjianzhang@20150908
        editor.clear();
        editor.apply();
        if (!isNonePickIntent) {
            ...
            editor.putString(SettingConstants.KEY_VOICE, voiceValue);//dengjianzhang@20150908
            editor.apply();
        }
