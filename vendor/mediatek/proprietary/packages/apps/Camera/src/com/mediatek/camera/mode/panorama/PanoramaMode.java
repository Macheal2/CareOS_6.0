...
public class PanoramaMode extends CameraMode {
    ...
    private boolean mShutterSoundEnable=true;//dengjianzhang@20150722
    ...
    public PanoramaMode(ICameraContext cameraContext) {
    	...
    	/**dengjianzhang@20150722 start*/
    	mShutterSoundEnable="on".equals(mISettingCtrl.getSettingValue(
        		SettingConstants.KEY_CAMERA_SHUTTER_SOUND));
        /**dengjianzhang@20150722 end*/
    }
    ...
    private void onPictureTaken(byte[] jpegData) {
        ...
        if (mCurrentNum == NUM_AUTORAMA_CAPTURE || mIsMerging) {
            ...
            /**dengjianzhang@20150722 start*/
        	//if (mCameraSound != null) {
            if (mCameraSound != null&&mShutterSoundEnable) {
            /**dengjianzhang@20150722 end*/	
