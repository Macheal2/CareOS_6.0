...
public class SettingConstants {
    ...
    public static final int SETTING_COUNT = 66; 
    // setting key
    ...
    /**dengjianzhang@20150709 add start*/
    ...
    /**dengjianzhang@20150709 add end*/
    public static final String KEY_CAMERA_TOUCH_PHOTOGRAPH = "pref_touch_photograph_key"; // added by bruce for touch photograph
	...
	public static final int ROW_SETTING_CAMERA_SHUTTER_SOUND      = 62;//dengjianzhang@20150611 add
    public static final int ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH   = 63; // added by bruce for touch photograph 
    public static final int ROW_SETTING_CAMERA_TIME_STAMP		  = 64;//dengjianzhang@20150709 add
    ...
    static {
        ...
        SETTING_TYPE[ROW_SETTING_CAMERA_SHUTTER_SOUND]      = ONLY_IN_PEFERENCE;//dengjianzhang@20150611 add 
        SETTING_TYPE[ROW_SETTING_CAMERA_TIME_STAMP]      	= ONLY_IN_PEFERENCE;//dengjianzhang@20150709 add  
        // added by bruce for touch photograph 
        SETTING_TYPE[ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH]   = ONLY_IN_PEFERENCE;
    ...
    static {
		...
		KEYS_FOR_SETTING[ROW_SETTING_CAMERA_SHUTTER_SOUND]  = KEY_CAMERA_SHUTTER_SOUND;//dengjianzhang@20150611 add  
		KEYS_FOR_SETTING[ROW_SETTING_CAMERA_TIME_STAMP]  	= KEY_CAMERA_TIME_STAMP;//dengjianzhang@20150709 add 
		// added by bruce for touch photograph 
		KEYS_FOR_SETTING[ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH] = KEY_CAMERA_TOUCH_PHOTOGRAPH;
    };
    ...
    public static final int[] SETTING_GROUP_CAMERA_FOR_TAB = new int[]{
        ...
        ROW_SETTING_DNG,
        ROW_SETTING_CAMERA_SHUTTER_SOUND,//dengjianzhang@20150611
        ROW_SETTING_CAMERA_TIME_STAMP,//dengjianzhang@20150709
        ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH, // added by bruce for touch photograph 
    ...
    public static final int[] UN_SUPPORT_BY_FRONT_CAMERA = new int[] {
        ...
        ROW_SETTING_GESTURE_SHOT,//caiji add for remove gesture shot in front camera
		ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH,// added by bruce for touch photograph
    };
