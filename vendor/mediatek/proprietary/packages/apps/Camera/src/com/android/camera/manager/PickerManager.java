...
public class PickerManager extends ViewManager implements Listener,
    ...
    static {
        ...
        sShownStatusRecorder[BUTTON_SMILE_SHOT] = false;//dengjianzhang@20150817
    }
        ...
        if (mListener != null) {
            ...
            case BUTTON_FLASH:
                ...
                if(newValue.equals("auto")){
                    mFlashPicker.setImageResource(R.drawable.btn_flash_auto);
                }else if(newValue.equals("on")){
                     mFlashPicker.setImageResource(R.drawable.btn_flash_on);
                }else if(newValue.equals("off")){
