...
public class ModePicker extends ViewManager implements View.OnClickListener,
    ...
    //modify by even c687 temp
    public static final int MODE_MAV = 10;
    public static final int MODE_MOTION_TRACK = 11;
    public static final int MODE_LIVE_PHOTO = 12;

    public static final int MODE_NUM_ALL = 13;//10;
    //end
    ...
    private static final int[] MODE_ICON_ORDER = { MODE_STEREO_CAMERA, MODE_PHOTO_PIP, MODE_LIVE_PHOTO, 
            MODE_MOTION_TRACK, MODE_FACE_BEAUTY,  MODE_MAV }; // detele ic_mode_photo_normal and ic_mode_panorama_focus
    static {
    ...
    private void highlightCurrentMode() {
        ...
        for (int i = 0; i < MODE_NUM_ALL; i++) {
            ...
            if (MODE_HDR == index || MODE_ASD == index
                ...
                //mModeViews[MODE_PHOTO].setImageResource(MODE_ICONS_HIGHTLIGHT[MODE_PHOTO]); /*zhouhua detele MODE_PHOTO  */
            }
        }
    }
    ...
    protected View getView() {
        ...
        //mModeViews[MODE_PHOTO] = (RotateImageView) view.findViewById(R.id.mode_photo);/* zhouhua detele MODE_PHOTO*/
    ...
    public void onRefresh() {
        ...
        mLayoutParams.setMargins(0, 0, 0, 0);//mModeMarginBottom //dengjianzhang@20150817 add start
