...
import com.android.camera.ui.ShutterButton;// dengjianzhang@20150728 add start
...
public class RecordingView extends CameraView implements OnClickListener {
    ...
    private ShutterButton mPauseResume;// dengjianzhang@20150728 add start
    ...
    @Override
    public View getView() {
        View view = inflate(R.layout.magcomm_recording);// dengjianzhang@20150728 add start
        mRecordingTime = (TextView) view.findViewById(R.id.recording_time);
        mPauseResume = (ShutterButton) view.findViewById(R.id.btn_pause_resume);// dengjianzhang@20150728 add start
    ...
    public void refresh() {
        ...
        int playpauseid = R.drawable.magcomm_video_going;// dengjianzhang@20150728 add start
        if (mIsRecordinging) {
            recordingId = R.drawable.ic_recording_indicator_play;
            playpauseid = R.drawable.magcomm_video_pause;// dengjianzhang@20150728 add start
        }
