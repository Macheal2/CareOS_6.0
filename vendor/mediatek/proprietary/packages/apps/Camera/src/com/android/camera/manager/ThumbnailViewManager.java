...
public class ThumbnailViewManager extends ViewManager implements OnClickListener,
    ...
    // dengjianzhang@20150728 add start
    private RotateImageView mThumbnailBackground;
    // dengjianzhang@20150728 add end
    ...
    public void setEnabled(boolean enabled) {
        ...
        if(mThumbnailBackground != null){
            mThumbnailBackground.setEnabled(false);
        }
        // dengjianzhang@20150728 add end
    ...
    protected View getView() {
		...
		// dengjianzhang@20150728 add start
        mThumbnailBackground = (RotateImageView) view.findViewById(R.id.thumbnail_background);
        // dengjianzhang@20150728 add end
        return view;
    }
        ...
        if (mThumbnailView != null && !mIsUpdatingThumbnail) {
            if (super.isShowing()) {
                ...
                if(mThumbnail == null  ||  mThumbnail.getBitmap() == null){
                    Bitmap  bitmap = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.border_last_picture);
