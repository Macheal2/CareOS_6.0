...
import com.mediatek.camera.platform.ICameraDeviceManager.ICameraDevice.AutoFocusMvCallback;//dengjianzhang@20160104 add
...
public class VideoMode extends CameraMode implements MediaRecorder.OnErrorListener,
    ...
    protected void doStartPreview() {
        ...
        if (mICameraDevice != null) {
            ...
            mICameraDevice.setAutoFocusMoveCallback(mAutoFocusMoveCallback);//dengjianzhang@20160104 add
        }
        if (mIFocusManager != null) {
