...
import com.android.camera.R;// dengjianzhang@20150728 add start
...
public class PickerButton extends RotateImageView implements View.OnClickListener {
    ...
    private boolean flashInitialization = true;// dengjianzhang@20150728 add start
    ...
    public void refresh() {
        ...
        if (!isVisible()) {
            ...
            // added by bruce for HDR menu exception begin
            if (mPreference == null){
                return;
            }
            // added by bruce for HDR menu exception end
            ...
            if (icons != null) {
                if (index >= 0 && index < icons.length) {
                    ...
                    if(flashInitialization &&  "pref_camera_flashmode_key".equals(mPreference.getKey())){
