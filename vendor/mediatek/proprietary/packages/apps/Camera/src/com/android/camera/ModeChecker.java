...
public class ModeChecker {
    ...
    public static void updateModeMatrix(CameraActivity camera, int cameraId) {
    	...
    	//dengjianzhang@20150817 start
    	MATRIX_NORMAL_ENABLE[ModePicker.MODE_STEREO_CAMERA][cameraId] = false;
    	//MATRIX_NORMAL_ENABLE[ModePicker.MODE_LIVE_PHOTO][cameraId] = false;//modify by even c687 temp
    	//MATRIX_NORMAL_ENABLE[ModePicker.MODE_MOTION_TRACK][cameraId] = false;//modify by even c687 temp
    	//MATRIX_NORMAL_ENABLE[ModePicker.MODE_FACE_BEAUTY][cameraId] = false;
    	//MATRIX_NORMAL_ENABLE[ModePicker.MODE_MAV][cameraId] = false;//modify by even c687 temp
    	//dengjianzhang@20150817 end
    }
