...
public class SettingListLayout extends FrameLayout implements InLineSettingItem.Listener,
    ...
    private boolean isSwitchSettingItem(ListPreference pref) {
        return SettingConstants.KEY_RECORD_LOCATION.equals(pref.getKey())
                ...
                || SettingConstants.KEY_CAMERA_SHUTTER_SOUND.equals(pref.getKey())//dengjianzhang@20150611
                || SettingConstants.KEY_CAMERA_TOUCH_PHOTOGRAPH.equals(pref.getKey()) // added by bruce for touch photograph
        		|| SettingConstants.KEY_CAMERA_TIME_STAMP.equals(pref.getKey());//dengjianzhang@20150709
    }
