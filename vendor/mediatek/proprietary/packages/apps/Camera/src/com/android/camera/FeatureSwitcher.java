...
public class FeatureSwitcher {
    ...
    public static boolean isLomoEffectEnabled() {
        ...
        return false;//enable dengjianzhang@20150701
    }
    ...
    public static boolean isShutterSoundEnable() {
        boolean enable = SystemProperties.getInt("ro.shutter_sound_support", 0) == 1 ? true
                : false;
        Log.i(TAG, "isShutterSoundEnable() return " + enable);
        return enable;
    }
    
    public static boolean isTimeStampSupport() {
        boolean enable = SystemProperties.getInt("ro.time_stamp_support", 0) == 1 ? true
                : false;
        Log.i(TAG, "isTimeStampSupport() return " + enable);
        return enable;
    }
    /**dengjianzhang@20150611 end*/ 

    // added by bruce for touch photograph begin
    public static boolean isTouchPhotographEnable() {
        boolean enable = SystemProperties.getInt("ro.touch_photograph_support", 0) == 1 ? true : false;
        Log.i(TAG, "isTouchPhotographEnable() return " + enable);
        return enable;
    }
