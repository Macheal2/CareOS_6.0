...
public class CameraManager {
    ...
    /**dengjianzhang@20150611 start*/
    private static final int ENABLE_SHUTTER_SOUND = 32;
    private static final int DISENABLE_SHUTTER_SOUND = 33;
    private static final int ENABLE_TIME_STAMP = 34;
    private static final int DISENABLE_TIME_STAMP = 35;
    /**dengjianzhang@20150611 end*/

    // added by bruce for touch photograph begin
    private static final int ENABLE_TOUCH_PHOTOGRAPH = 36;
    private static final int DISENABLE_TOUCH_PHOTOGRAPH = 37;
    // added by bruce for touch photograph end
    ...
    private static String getMsgLabel(int msg) {
        ...
        case DISENABLE_SHUTTER_SOUND :
            return "[disenableShutterSound] ";
        case ENABLE_TIME_STAMP :
            return "[enableTimeStamp] ";
        case DISENABLE_TIME_STAMP :
            return "[disenableTimeStamp] ";
        /**dengjianzhang@20150611 end*/  

        // added by bruce for touch photograph begin
        case ENABLE_TOUCH_PHOTOGRAPH :
            return "[enableTouchPhotograph] ";
        case DISENABLE_TOUCH_PHOTOGRAPH :
            return "[disenableTouchPhotograph] ";
        // added by bruce for touch photograph end
        ...
        public void handleMessage(final Message msg) {
            ...
            try {
                ...
                case ENABLE_SHUTTER_SOUND:
                	...
                	break;
                case DISENABLE_SHUTTER_SOUND:
                	mCamera.disenableShutterSound();
                	break;
                case ENABLE_TIME_STAMP:
                	mCamera.enableTimeStamp();
                	break;
                case DISENABLE_TIME_STAMP:
                	mCamera.disenableTimeStamp();
                	break;
                /**dengjianzhang@20150611 end*/

                // added by bruce for touch photograph begin
                case ENABLE_TOUCH_PHOTOGRAPH:
                	mCamera.enableTouchPhotograph();
                	break;
                case DISENABLE_TOUCH_PHOTOGRAPH:
                	mCamera.disenableTouchPhotograph();
                	break;
                // added by bruce for touch photograph end
    ...
    public class CameraProxy {
        ...
        public void disenableShutterSound(){
            mCameraHandler.sendEmptyMessage(DISENABLE_SHUTTER_SOUND);
            waitDone();
        }
        
        public void enableTimeStamp(){
        	mCameraHandler.sendEmptyMessage(ENABLE_TIME_STAMP);
        	waitDone(); 
        }
        	      	
        public void disenableTimeStamp(){
        	mCameraHandler.sendEmptyMessage(DISENABLE_TIME_STAMP);
        	waitDone(); 
        }   
        /**dengjianzhang@20150611 end*/

        // added by bruce for touch photograph begin
        public void enableTouchPhotograph(){
            mCameraHandler.sendEmptyMessage(ENABLE_TOUCH_PHOTOGRAPH);
            waitDone();
        }
        	
        public void disenableTouchPhotograph(){
            mCameraHandler.sendEmptyMessage(DISENABLE_TOUCH_PHOTOGRAPH);
            waitDone();
        }     	
        // added by bruce for touch photograph end
        // / @}
