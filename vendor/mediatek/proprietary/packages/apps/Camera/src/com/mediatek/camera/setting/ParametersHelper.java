...
public class ParametersHelper {
    ...
    public static void setParametersValue(Parameters parameters, int cameraId, String key,
        ...
        case SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND:

            break;  
            
        case SettingConstants.ROW_SETTING_CAMERA_TIME_STAMP:

            break;
        /**dengjianzhang@20150611 end*/

        // added by bruce for touch photograph begin
        case SettingConstants.ROW_SETTING_CAMERA_TOUCH_PHOTOGRAPH:
            break;     	
