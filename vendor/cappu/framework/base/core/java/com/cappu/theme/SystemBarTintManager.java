...
public class SystemBarTintManager {
    ...
    public SystemBarTintManager(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            try {
                mStatusBarAvailable = true;//a.getBoolean(0, false);//false
                mNavBarAvailable = true;//a.getBoolean(1, false);//false
            } finally {
                a.recycle();
            }
    ...
    public void setTintDrawable(int drawableResID) {
        setStatusBarTintDrawable(drawableResID);
        setNavigationBarTintDrawable(drawableResID);
    }
    
    public void setStatusBarTintDrawable(int drawableResID) {
        if (mStatusBarAvailable) {
            mStatusBarTintView.setBackgroundResource(drawableResID);
        }
    }
    public void setNavigationBarTintDrawable(int drawableResID) {
        if (mNavBarAvailable) {
            mNavBarTintView.setBackgroundResource(drawableResID);
        }
    }
