...
import com.cappu.calendar.BasicActivity;
import com.cappu.calendar.Workspace.ProcessDate;
import com.cappu.calendar.Workspace.TouchFinish;
import com.cappu.calendar.dialog.CareDatePickerDialog.OnDateSetListener;
...
// // 数据库存储路径
//    String filePath = "data/data/com.cappu.calendar/databases/calendar.db";
//    // 数据库存放的文件夹 data/data/com.main.jh 下面
//    String pathStr = "data/data/com.cappu.calendar/databases";
...
//    public static String mSolarterm_array[]; 
    ...
    public SQLiteDatabase openDatabase(Context context) {
        File jhPath = new File(FirstActivity.filePath);
        // 查看数据库文件是否存在
        if (jhPath.exists()) {
            // 存在则直接返回打开的数据库
            ...
            // 不存在先创建文件夹
            File path = new File(FirstActivity.pathStr);
            if (path.mkdir()) {
                Log.e("HHJ","创建成功");
            } else {
                Log.e("HHJ","创建失败");
