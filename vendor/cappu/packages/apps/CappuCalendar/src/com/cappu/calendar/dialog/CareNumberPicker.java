...
import com.cappu.calendar.LocaleData;
...
public class CareNumberPicker extends LinearLayout {
    ...
    private final Paint mMiddleIndexPaint;
    ...
    public interface OnValueChangeListener {
         ...
         *
         * @param picker The CareNumberPicker associated with this listener.
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(CareNumberPicker view, int scrollState);
    }
     ...
     */
    public CareNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        // process style attributes
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.NumberPicker, defStyle, 0);
        final int layoutResId = R.layout.care_number_picker;
        ...
        mInputText.setTextSize((int)(mInputText.getTextSize() * 1));
        ...
        mMiddleIndexPaint.setTextSize(mTextSize);
    ...
    private boolean moveToFinalScrollerPosition(Scroller scroller) {
        ...
        if ((increment && (scrollerCurrY > scrollerStartY || scrollerCurrY < scrollerFinalY)) ||
                (!increment && (scrollerCurrY > scrollerFinalY || scrollerCurrY < scrollerStartY))) {
    ...
    */}
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            Log.i("nian","mInputText.getVisibility() = " + mInputText.getVisibility());
            Log.i("nian","VISIBLE = " + VISIBLE);
        ...
        public CharSequence filter(
            ...
            if (mDisplayedValues == null) {
                ...
                if (TextUtils.isEmpty(filtered)) {
                    /// M: Change language will cause onRestoreInstanceState bring previous state into mInputText,
                    /// it leads the string comparsion between source and mDisplayedValues being difference.
                    /// It should remove selection command if the string is empty after the comparsion.
                    if (mSetSelectionCommand != null) {
                        removeCallbacks(mSetSelectionCommand);
                    }
                    return "";
