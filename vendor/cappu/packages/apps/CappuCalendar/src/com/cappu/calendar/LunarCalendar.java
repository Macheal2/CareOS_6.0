...
public class LunarCalendar {
    ...
    public String getLunarDate(int year_log, int month_log, int day_log, String jieqi, boolean isday) {
        ...
        if (!isday) {
            ...
            for(int i = 0; i < FirstActivity.mSolarterm_array.length; i++){
                //返回节气
                String sd = FirstActivity.mSolarterm_array[i].split(" ")[0]; // 节假日的日期
                String sdv = FirstActivity.mSolarterm_array[i].split(" ")[1]; // 节假日的名称
