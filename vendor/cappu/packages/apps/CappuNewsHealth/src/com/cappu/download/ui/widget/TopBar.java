package com.cappu.download.ui.widget;
...
public class TopBar extends ViewGroup implements OnClickListener {
    ...
    public Drawable mLeftDraw, mRightDraw;
    ...
    public int mLeftVisibility, mRightVisibility;
    public int mLineWidth, mLineHeight;
    ...
    /**左右的分割线*/
    public View mLeftLine, mRightLine;
    public ImageButton mLeftImage, mRightImage;
    ...
    public TopBar(Context context, AttributeSet attrs) {
        ...
        if (mLeftDraw == null) {
            mLeftDraw = context.getResources().getDrawable(R.drawable.icon_back);
        }

        if (mRightDraw == null) {
            mRightDraw = context.getResources().getDrawable(R.drawable.icon_option);
        }
