...
//        x.Ext.init(activity.getApplication());
    ...
    static String getVCode(Context context){
        if(context != null && context.getPackageName().equals("com.cappu.download")){
            return "&vcode="+0;
        }
    ...
    static String getPack(Context context){
        if(context != null && context.getPackageName().equals("com.cappu.download")){
            return "&pack="+"com.magcomm.ishare";
        }
    ...
    private static String md5EncodeToString(String values){
        try {
            ...
            e.printStackTrace();
            if(Util.ERROR_DEBUG)Log.e(Util.TAG, "ERROR ----UpdateCenter ----UnsupportedEncodingException :"+e.toString());
        }
        return null;
    }
