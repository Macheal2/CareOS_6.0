...
package com.cappu.drugsteward.example.xing.camera;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        final int resourceId = this.context.getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            mStatusBarHeight = this.context.getResources().getDimensionPixelSize(resourceId);
        }
        ...
        screenResolution = new Point(display.getWidth(), display.getHeight() - mStatusBarHeight);
