...
public class QrcodeResult extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        copybutton = (Button) this.findViewById(R.id.copystring);// 复制文本
        sharebutton = (Button) this.findViewById(R.id.sharestring);// 分享
        ...
        if (null != intent) {
            ...
            Toast.makeText(this, "===内容==" + scanResult, 0).show();
    ...
    private void CopyString() {
        ...
        Log.i("test", R.string.replicated + "=复制=");
