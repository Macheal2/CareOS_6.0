...
JNIEXPORT jint JNICALL Java_sim_android_mtkcit_cittools_CITJNI_getPSValue
...
JNIEXPORT jint JNICALL Java_sim_android_mtkcit_cittools_CITJNI_getALSValue
(JNIEnv *env, jobject obj)
{
...
int get_ps_thd(void);
JNIEXPORT jintArray JNICALL Java_sim_android_mtkcit_cittools_CITJNI_getPSTHD
(JNIEnv *env, jobject obj)
{
...
int  get_ps_raw_cali();
JNIEXPORT jintArray JNICALL Java_sim_android_mtkcit_cittools_CITJNI_PSCali
(JNIEnv *env, jobject obj)
{
    jintArray  array;
     int i;
...
return array;
    ...
    int set_ps_cali();
 //    int get_ps_thd();
JNIEXPORT jint JNICALL Java_sim_android_mtkcit_cittools_CITJNI_PSCali2
...
JNIEXPORT jint JNICALL Java_sim_android_mtkcit_cittools_CITJNI_PSCali3
...
JNIEXPORT jint JNICALL Java_sim_android_mtkcit_cittools_CITJNI_PSwritenvram
(JNIEnv *env, jobject obj ,jint far,jint close ,jint valid)
{     
...
JNIEXPORT jint JNICALL Java_sim_android_mtkcit_cittools_CITJNI_setLeftSpeaker
(JNIEnv *env, jobject obj)
{
...
JNIEXPORT jint JNICALL Java_sim_android_mtkcit_cittools_CITJNI_setRightSpeaker
(JNIEnv *env, jobject obj)
{
