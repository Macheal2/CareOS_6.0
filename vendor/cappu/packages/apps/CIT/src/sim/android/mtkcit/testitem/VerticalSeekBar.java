 ...
 *  Creator  :  yong.hua 
 *  Date     :  2011/9/1
 *  Comment  :  CIT Test -> HeadSet Test -> Vertical SeekBar View Widget , based on SeekBar.java 
 *   
 */
...
public class VerticalSeekBar extends AbsSeekBar {
    ...
    void onProgressRefresh(float scale, boolean fromUser) {
        ...
        private void setThumbPos(int w, Drawable thumb, float scale, int gap) {
            int available = w-getPaddingLeft()-getPaddingRight();	//mod by wangkang 2012.4.20 bug180
        ...
        {
        		width = 48; //28;		//mod by wangkang 2012.4.20 bug180
        		height = 180; //120;	//mod by wangkang 2012.4.20 bug180
