...
import com.example.xing.activity.CaptureActivity;
import com.example.xing.encoding.EncodingHandler;
...
public class QrcodeScanner extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		*/
		Intent openCameraIntent = new Intent(QrcodeScanner.this,
	...
	private void openUrl() {
        ...
        /*if(uri.startsWith(WEIXIN_URL_HEAD)) {
        	resultTextView.setText(getResources().getString(R.string.weixinerror));
        	mLayouttext.setVisibility(View.VISIBLE);
            return;
        }*/
		...
		try {
			...
			if (!contentString.equals("")) {
				...
				File f = new File(Environment.getExternalStorageDirectory()
						+ "/page/" + "wangziqi" + System.currentTimeMillis()
						+ ".jpg");
				FileOutputStream fos = null;
				try {
					fos = new FileOutputStream(f);
					qrCodeBitmap.compress(Bitmap.CompressFormat.JPEG, 50, fos);
					Toast.makeText(getApplicationContext(), getResources().getString(R.string.savebitmap),
				...
				Toast.makeText(QrcodeScanner.this, getResources().getString(R.string.input_text),
						Toast.LENGTH_SHORT).show();
			}
