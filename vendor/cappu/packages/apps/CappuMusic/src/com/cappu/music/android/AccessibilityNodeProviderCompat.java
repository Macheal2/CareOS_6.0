 ...
 * {@link android.view.accessibility.AccessibilityNodeProvider} introduced after
...
public class AccessibilityNodeProviderCompat {
    ...
    static class AccessibilityNodeProviderJellyBeanImpl extends AccessibilityNodeProviderStubImpl {
        ...
        public Object newAccessibilityNodeProviderBridge(final AccessibilityNodeProviderCompat compat) {
            return AccessibilityNodeProviderCompatJellyBean
                    .newAccessibilityNodeProviderBridge(new AccessibilityNodeProviderCompatJellyBean.AccessibilityNodeInfoBridge() {
                        @Override
                        ...
                        public Object createAccessibilityNodeInfo(int virtualViewId) {
                            final AccessibilityNodeInfoCompat compatInfo = compat.createAccessibilityNodeInfo(virtualViewId);
                            if (compatInfo == null) {
                                return null;
                            } else {
     ...
     * view, i.e. a descendant of the host View, with the given
     * <code>virtualViewId</code> or the host View itself if
     ...
     * the host View, with the given <code>virtualViewId</code> or the host View
     * itself if <code>virtualViewId</code> equals to {@link View#NO_ID}.
     * 
     * @param virtualViewId
     *            A client defined virtual view id.
     * @param action
     ...
     * a descendant of the host View, with the given <code>virtualViewId</code>
     * or the host View itself <code>virtualViewId</code> equals to
     * {@link View#NO_ID}.
     * 
     * @param virtualViewId
     *            A client defined virtual view id which defined the root of the
     *            tree in which to perform the search.
     * @param text
     *            The searched text.
