...
public class AudioPreviewStarter extends Activity
    ...
    private void processForDrm(Uri uri) {
        ...
        if (schemeContent.equals(scheme) && hostMedia.equals(host)) {
            ...
            c = resolver.query(uri, new String[] { MediaStore.Audio.Media._ID, /*MediaStore.Audio.Media.IS_DRM*/null, /*MediaStore.Audio.Media.DRM_METHOD*/null }, null, null, null);
            ...
            c = resolver.query(contentUri, new String[] { MediaStore.Audio.Media._ID, /*MediaStore.Audio.Media.IS_DRM*/null,
                    /*MediaStore.Audio.Media.DRM_METHOD*/null }, where.toString(), null, null);
        }
        if (c != null) {/*
            try {
                if (c.moveToFirst()) {
