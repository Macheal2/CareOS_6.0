...
public class KookController {
    ...
    public KookController(Context context, DialogInterface di, Window window) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
        mHandler = new ButtonHandler(di);

        mAlertDialogLayout = R.layout.kook_dialog;
    ...
    private boolean setupButtons() {
        ...
        if(whichButtons == 3 || whichButtons == 7){
            // right
            mButtonPositive.setBackgroundResource(R.drawable.dialog_right_button_bg);
            // left
            mButtonNegative.setBackgroundResource(R.drawable.dialog_left_button_bg);
            // middle
            mButtonNeutral.setBackgroundResource(R.drawable.dialog_middle_button_bg);
        }else if (whichButtons == 6 ){
            mButtonNegative.setBackgroundResource(R.drawable.dialog_left_button_bg);
            mButtonNeutral.setBackgroundResource(R.drawable.dialog_right_button_bg);
        }else if (whichButtons == 5 ){
            mButtonNeutral.setBackgroundResource(R.drawable.dialog_left_button_bg);
            mButtonPositive.setBackgroundResource(R.drawable.dialog_right_button_bg);
        }else if (whichButtons == 2 ){
            mButtonNegative.setBackgroundResource(R.drawable.dialog_button_bg);
        }else if (whichButtons == 1 ){
            mButtonPositive.setBackgroundResource(R.drawable.dialog_button_bg);
        }else if (whichButtons == 4 ){
            mButtonNeutral.setBackgroundResource(R.drawable.dialog_button_bg);
        }
...
/*
    ...
    public static class AlertParams {
        ...
        public void apply(KookController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final KookController dialog) {/*
