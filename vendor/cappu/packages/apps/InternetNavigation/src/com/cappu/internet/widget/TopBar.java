...
import com.cappu.internet.widget.CappuTextView;
...
public class TopBar extends ViewGroup implements OnClickListener{
    ...
    private CappuTextView mTitle;
    private CappuTextView mSubTitle;
    ...
    public TextView getTitle(){
        ...
        if(mTitle == null){
            mTitle = new CappuTextView(getContext());
    ...
    public TextView getSubTitle(){
        ...
        if(mSubTitle == null){
            mSubTitle = new CappuTextView(getContext());
