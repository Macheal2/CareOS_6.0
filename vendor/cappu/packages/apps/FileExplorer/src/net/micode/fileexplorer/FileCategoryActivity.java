...
public class FileCategoryActivity extends Fragment implements IFileInteractionListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFileViewActivity = (FileViewActivity) ((FileExplorerTabActivity) mActivity).getFragment(Util.SDCARD_TAB_INDEX);
    ...
    private void copyFileInFileView(ArrayList<FileInfo> files) {
        ...
        if(mActivity instanceof FileExplorerTabActivity){
            FileExplorerTabActivity fta = (FileExplorerTabActivity)mActivity;
            fta.getTabHost().setCurrentTab(Util.SDCARD_TAB_INDEX);
        }
    }
    ...
    private class ScannerReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.v("dengying", "received broadcast: " + action.toString());
