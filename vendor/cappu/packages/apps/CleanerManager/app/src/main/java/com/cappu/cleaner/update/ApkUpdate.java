...
public class ApkUpdate {
    ...
    /**服务器上的版本号 对应的名字*/
    public static final String UPGRADE_VERSION_KEY ="version";
    /**服务器上的版本号 */
    public static final String UPGRADE_VCODE_KEY ="vcode";
    /** 当前检测的时间 */
        ...
        mAsyncTask = new AsyncTask<String, Void, ApkInfo>() {
            ...
            protected ApkInfo doInBackground(String... params) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    if(Util.DEBUG)Log.e(Util.TAG, "ApkUpdate"+"ERROR ----ClientProtocolException :" + e.toString());
                } catch (IOException e) {
                    if(Util.DEBUG)Log.e(Util.TAG, "ApkUpdate"+"ERROR ----IOException :" + e.toString());
                } catch (JSONException e) {
                    e.printStackTrace();
                    if(Util.DEBUG)Log.e(Util.TAG, "ApkUpdate"+"ERROR ----JSONException :" + e.toString());
                }
    ...
    private void tips(final ApkInfo apkInfo) {
        if (mAlertDialog == null) {
            ...
            builder.setPositiveButton(R.string.ok_action, new OnClickListener() {
                @Override
