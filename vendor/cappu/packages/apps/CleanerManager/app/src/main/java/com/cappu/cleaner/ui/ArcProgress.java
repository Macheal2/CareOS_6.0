...
public class ArcProgress extends View {
    ...
    private final int default_unfinished_color = Color.argb(0x40,0xff, 0xff, 0xff);
    ...
    private float mDisplayViewArea;
    ...
    protected void initPainters() {
        ...
        paint.setStrokeCap(Paint.Cap.ROUND);//画笔的笔触为圆角

        float rectOffset = mViewOffset + strokeWidth / 2f;
        rectF.set(rectOffset, rectOffset, mViewWidth - rectOffset, mViewWidth - rectOffset);
    }
    ...
    private void getScreen() {
        ...
        mViewWidth = (int)(mScreenWidth * mDisplayViewArea);
        mViewHeight = (int)(mScreenWidth * mDisplayViewArea);
        mViewOffset = (int)(mViewWidth * 0.07);
    }
    ...
    public void setProgress(int progress) {
        this.progress = (getMax() >= progress) ? progress : progress % getMax();
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float startAngle = -90;//270 - arcAngle / 2f;
        ...
        if (mState != MonitorBall.FINISH) {
            ...
            if (!TextUtils.isEmpty(text)) {
                ...
                canvas.drawText(suffixText,
                        (getWidth() + textWidth) / 2.0f + suffixTextPadding,
                        textBaseline, textPaint);
            }
        }
