...
CUSTOM_HAL_IMGSENSOR = imx219_mipi_raw gc5005_mipi_raw gc5025_mipi_raw ov13850_mipi_raw
...
CUSTOM_HAL_MSENSORLIB = mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 mc6420 mmc3416x s62xd lsm303md hscdtd006 qmc5983 akmd09911 mc64xx bmm056 mc41xx qmcX983d
...
CUSTOM_KERNEL_IMGSENSOR = imx219_mipi_raw gc5005_mipi_raw gc5025_mipi_raw ov13850_mipi_raw
...
CUSTOM_MODEM = magc6737m_65_c_m0_c2k_svlte_om_c687 magc6737m_65_c_m0_ltg_dsds_c687 magc6737m_65_c_m0_lwg_dsds_c687
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
DCORE_TEST_MODE1 = no
DEFAULT_INPUT_METHOD = com.baidu.input_spec.ImeService
...
MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.164.3_magc6737t.66.c.m0
MTK_BWC_SUPPORT = yes
...
MAGCOMM_UI =Care_OS
#hejianfeng add for launcherwin
MAGCOMM_LAUNCHERWIN_SUPPORT=yes
#CREATE_PROJECT_INFO=20160922181638
#zhouhua add  IShare 20170428
CAPPU_ISHARE_SUPPORT=yes
#zhouhua add  DZH 20170428
CAPPU_DZH_SUPPORT=yes
#zhouhua add MagcommCalendar 20170428
CAPPU_CALENDAR_SUPPORT=yes
#zhouhua add InternetNavigation 20170428
CAPPU_INTERNET_NAVIGATION=yes
#zhouhua add DownLoadCenter 20170428
DOWNLOADCENTER_APP_SUPPORT=yes
# zhouhua  add CaiYiDaDao 20170428
CAPPU_CAIYIDADAO_SUPPORT=yes
# zhouhua  add SOS 20170428
CAPPU_SOS_SUPPORT=yes
# zhouhua  add I99ReadMe 20170428
CAPPU_I99README_SUPPORT=yes
# zhouhua  add 2345browser 20170503
CAPPU_2345BROWSER_SUPPORT=no
# zhouhua  add cappu care 20170503
CAPPU_CAPPU_CARE_SUPPORT=yes
# zhouhua add weixin 20170504
CAPPU_WEIXIN_SUPPORT=yes
#zhouhua add QrcodeScanner 20170504
CAPPU_QRCODE_SCANNER=yes
#zhouhua add FileExplorer 20170504
CAPPU_FILEEXPLORER_SUPPORT=no
#zhouhua add Magnifiter 20170504
CAPPU_MAGNIFITER_SUPPORT=yes
#zhouhua add bootanim 20170504
CAPPU_BOOTANIM_SUPPORT=yes
#zhouhua add Baiduinput 20170505
CAPPU_BAIDUINPUT_SUPPORT=yes
#modify by hmq
CAPPU_KEYGUARD_PICTORIAL=yes
#dengying add CIT
CAPPU_CIT_SUPPORT=yes
#zhouhua add healthCenter
CAPPU_HEALTHCENTER_SUPPORT=yes
#zhouhua add TencentMobileAssistant
CAPPU_TENCENTMOBILEASSISTANT_SUPPORT=yes
#zhouhua add Bootaudio
CAPPU_BOOTAUDIO_SUPPORT=yes
#zhouhua add BaiduSerach
CAPPU_BAIDUSEARCH_SUPPORT=yes
#zhouhua add CappuHelper
CAPPU_CAPPUHELPER_SUPPORT=yes
#zhouhua add CappuNaQuBa
CAPPU_CAPPUNAQUBA_SUPPORT=yes
#zhouhua add AppCollection
CAPPU_APPCOLLECTION_SUPPORT=yes
#hejianfeng add for hall
MAGCOMM_HALL_SUPPORT=yes
#zhouhua add TencentMobileAssistant
CAPPU_TENCENTMOBILEASSISTANT_SUPPORT=yes
#zhouhua add DeskClockCappu
CAPPU_DESKCLOCKCAPPU_SUPPORT=yes
#zhouhua add CalculatorCappu
CAPPU_CALCULATORCAPPU_SUPPORT=yes
#hmq add Cleanedr Manager
CAPPU_CLEANEDR_MANAGER=yes
#zhouhua add DouDiZhu
CAPPU_DOUDIZHU_SUPPORT=yes
#zhouhua add HuanLeMaJiang
CAPPU_HUANLEMAJIANG_SUPPORT=yes
#zhouhua add JunQi
CAPPU_JUNQI_SUPPORT=yes
#zhouhua add WuZiQi
CAPPU_WUZIQI_SUPPORT=yes
#zhouhua add ZhongGuoXiangQi
CAPPU_ZHONGGUOXIANGQI_SUPPORT=yes
#jiangyan add Healthmanage
CAPPU_HEALTHMANAGE_SUPPORT=yes
#zhouhua add BaiduMap
CAPPU_BAIDUMAP_SUPPORT=yes
#zhouhua add QQMusic
CAPPU_QQMUSIC_SUPPORT=yes
#zhouhua add TDsquareDance
CAPPU_TDSQUAREDANCE_SUPPORT=yes
