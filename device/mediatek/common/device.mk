...
#zhouhua add QQBrowser begin
ifeq ($(strip $(CAPPU_QQBROWSER_SUPPORT)),yes)
  PRODUCT_PACKAGES += QQBrowser
endif
#zhouhua add QQBrowser end
...
#zhouhua add 20170904 TXManager begin
ifeq ($(strip $(CAPPU_TXMANAGER_SUPPORT)),yes)
  PRODUCT_PACKAGES +=TXManager
endif
#zhouhua add 20170904 TXManager end
#zhouhua add 20170904 TXReading begin
ifeq ($(strip $(CAPPU_TXREADING_SUPPORT)),yes)
  PRODUCT_PACKAGES +=TXReading
endif
#zhouhua add 20170904 TXReading end
