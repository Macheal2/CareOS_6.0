...
$(call intermediates-dir-for,APPS,cappu-res,,COMMON)/package-export.apk:$(call intermediates-dir-for,APPS,mediatek-res,,COMMON)/src/R.stamp
...
framework_res_package_export := \
 ...
 #modify by y.haiyang (start)
  ...
  ifneq ($(LOCAL_NO_MTKRES), true)
    ...
    ifneq ($(LOCAL_NO_CAPPU_RES), true)
        cappu_res_package_export += \
            $(call intermediates-dir-for,APPS,cappu-res,,COMMON)/package-export.apk
        cappu_res_package_export_deps += \
            $(call intermediates-dir-for,APPS,cappu-res,,COMMON)/src/R.stamp
    endif
  endif
 # modify by y.haiyang (end)
...
$(filter-out $(cappu_res_package_export),$(resource_export_package)): $(cappu_res_package_export_deps)
$(R_file_stamp): $(cappu_res_package_export_deps)
#add by y.haiyang (end)
$(resource_export_package) $(R_file_stamp) $(LOCAL_BUILT_MODULE): $(all_library_res_package_export_deps)
$(LOCAL_INTERMEDIATE_TARGETS): \
    PRIVATE_AAPT_INCLUDES := $(all_library_res_package_exports) $(cappu_res_package_export)
