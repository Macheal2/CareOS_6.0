 ...
 * contacts per group and number of groups per account. This list is sorted by
 * account type, account name, where the group names are in alphabetical order.
 * Note that the list excludes default, favorite, and deleted groups.
 */
public final class I99GroupListLoader extends CursorLoader {
    ...
    public I99GroupListLoader(Context context) {
        super(context, GROUP_LIST_URI, COLUMNS, Groups.ACCOUNT_TYPE
