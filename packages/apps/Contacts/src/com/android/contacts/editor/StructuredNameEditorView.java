...
public class StructuredNameEditorView extends TextFieldsEditorView {
    ...
    public void setValues(DataKind kind, ValuesDelta entry, RawContactDelta state, boolean readOnly,
        ...
        //add by zxy for 'add focus and keyboard' start from 20170821
        requestFocusForFirstEditField();
        editNewlyAddedField();
        //add by zxy end
        updateEmptiness();
    }
    //wangcunxi add begin Care_os(editor text changed Name is Empty)
    private boolean isChangedEmpty = false;
    public boolean getNameEmpty(){
        return isChangedEmpty;
    }
    //wangcunxi add end
    @Override
