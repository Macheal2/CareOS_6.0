...
import android.provider.ContactsContract.CommonDataKinds.Phone; //wangcunxi modify
/**
...
public class RawContactEditorView extends BaseRawContactEditorView {
    ...
    public void setState(RawContactDelta state, AccountType type, ViewIdGenerator vig,
        ...
        if (mGroupMembershipKind != null) {
            ...
            mGroupMembershipView = (GroupMembershipView)mInflater.inflate(
                    R.layout.care_item_group_membership, mFields, false);
        ...
        for (DataKind kind : type.getSortedDataKinds()) {
            ...
            if (StructuredName.CONTENT_ITEM_TYPE.equals(mimeType)) {
               ...
               //wangcunxi delete end 
                ...
                if (mGroupMembershipView != null) {
                    ...
                    if (!isProfile) {
                        //mFields.addView(mGroupMembershipView);//dengying modify
                    }
                }
            ...
            /// @}
				...
				if(!(kind.mimeType.equals(Phone.CONTENT_ITEM_TYPE)))continue;//wangcunxi modify Care_os
                //wangcunxi modify Care_os begin
                /*final KindSectionView section = (KindSectionView)mInflater.inflate(
                        R.layout.item_kind_section, mFields, false);*/
						
				final KindSectionView section = (KindSectionView)mInflater.inflate(
                        R.layout.care_item_kind_section, mFields, false);			
				//wangcunxi modify Care_os end
    ...
    /** @} **/
    //wangcunxi add begin CNext_os(get item editor)
    public KindSectionView getEditor(String mimeType){
    int count = mFields.getChildCount();
    for (int i = 0; i < count; i++) {
        View view = mFields.getChildAt(i);
        if(view instanceof KindSectionView){
            KindSectionView section = (KindSectionView)view;
            if(mimeType.equals(section.getKind().mimeType)){
                return section;
            }
        }
    }
