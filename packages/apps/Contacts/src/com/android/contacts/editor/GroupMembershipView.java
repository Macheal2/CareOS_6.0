...
public class GroupMembershipView extends LinearLayout
    ...
    protected void onFinishInflate() {
        ...
        mI99Data = new ArrayList<GroupSelectionItem>();// add by y.haiyang for i99
    }
    ...
    public void onClick(View v) {
        ...
        mPopup.setAnimationStyle(R.style.CarePopupAnimation);
		//wangcunxi add end
        mPopup.show();
    ...
    // add by y.haiyang for i99 (start)
     private void showChooseGroupDialog(){
        mI99Dialog = new Dialog(mContext, R.style.I99DialogStyle);
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.i99_choose_group_dialog, null);
        TextView title = (TextView) view.findViewById(R.id.title);
        Button reset = (Button)view.findViewById(R.id.no_group);
        reset.setOnClickListener(new I99OnClickListener() );

        ListView list = (ListView)view.findViewById(R.id.i99_group_list);
        list.setAdapter(new I99ListAdapter());
        list.setOnItemClickListener(new I99ItemClickListener());
        ...
        mI99Dialog.addContentView(view, lp);
        mI99Dialog.show();
        Window window = mI99Dialog.getWindow();
    ...
    private void getI99Data(){
        ...
        while (mGroupMetaData.moveToNext()) {
            long groupId = mGroupMetaData.getLong(GroupMetaDataLoader.GROUP_ID);
            String title = mGroupMetaData.getString(GroupMetaDataLoader.TITLE);
            mI99Data.add(new GroupSelectionItem(groupId, title, false));
        }
    }
    ...
    private class I99OnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            clearGroupId();
            updateView();
            if(mI99Dialog != null && mI99Dialog.isShowing()){
                mI99Dialog.dismiss();
            }
    ...
    private class I99ItemClickListener implements AdapterView.OnItemClickListener {

        @Override
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            clearGroupId();
            GroupSelectionItem item = mI99Data.get(arg2);
            long groupId = item.getGroupId();
    ...
    private class I99ListAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            return mI99Data.size();
        }

        @Override
        public Object getItem(int position) {
            // TODO Auto-generated method stub
            return mI99Data.get(position);
        }
        ...
        public View getView(int position, View view, ViewGroup arg2) {
            if(view == null){
                LayoutInflater inflater = LayoutInflater.from(mContext);
                view = inflater.inflate(R.layout.i99_group_list_item_layout, null);
            }
            Button item = (Button)view;
            item.setText(mI99Data.get(position).toString());
            if(mI99Data.size() == 1){
                item.setBackgroundResource(R.drawable.i99_list_one_item_bg);
            }else if(position == 0){
                item.setBackgroundResource(R.drawable.i99_list_top_bg);
            }else if(position == (mI99Data.size() - 1)){
                item.setBackgroundResource(R.drawable.i99_list_bottom_bg);
            }else{
                item.setBackgroundResource(R.drawable.i99_list_middle_bg);
            }
            return view;
        }
