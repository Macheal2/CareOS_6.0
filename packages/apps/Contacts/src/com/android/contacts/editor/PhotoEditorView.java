...
// add by y.haiyang for i99_os (start)
...
// add by y.haiyang for i99_os (end)
...
public class PhotoEditorView extends LinearLayout implements Editor {
    ...
    protected void resetDefault() {
		...
		*/
		...
		mPhotoImageView.setImageResource(getPhotoImageResource());//wangcunxi add
        mHasSetPhoto = false;
