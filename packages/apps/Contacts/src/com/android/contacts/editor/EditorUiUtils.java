...
public class EditorUiUtils {
    ...
    public static int getLayoutResourceId(String mimetype) {
        ...
        if (id == null) {
            ...
            //turn R.layout.text_fields_editor_view;
            return R.layout.care_text_fields_editor_view;
    ...
    public static Pair<String,String> getAccountInfo(Context context, boolean isProfile,
        ...
        if (!TextUtils.isEmpty(accountName)) {
            ...
            if (accountType != null && accountType.isIccCardAccount()) {
                accountTypeLabel = context.getString(R.string.account_type_format,
                        accountTypeDisplayLabel);
            } else {
                accountTypeLabel = (String) accountTypeDisplayLabel;
            }
            return new Pair<>(
                    accountNameDisplayLabel,accountTypeLabel);
            /// @}
        }
        return null;
    }
