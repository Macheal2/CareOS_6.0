...
import java.util.Locale;////wangcunxi modify
...
//        }
        //系统语言 yuantongqin add 

        preferences = getSharedPreferences(LANGUAGE_TAG,Context.MODE_PRIVATE);
    ...
    //local Language 系统当前语言language
    public void setSystemLanguage(String s){
