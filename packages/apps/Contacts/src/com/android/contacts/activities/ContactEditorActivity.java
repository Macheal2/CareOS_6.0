...
public class ContactEditorActivity extends ContactEditorBaseActivity
    ...
    public void onCreate(Bundle savedState) {
		...
		if (ContactEditorBaseActivity.ACTION_EDIT.equals(action)) {
            mFragment.updateTitle(getResources().getString(R.string.contact_editor_title_existing_contact));
        } else {
            mFragment.updateTitle(getResources().getString(R.string.contact_editor_title_new_contact));
        }
