...
import com.cappu.contacts.I99PhoneBookActivity;
...
public class PeopleActivity extends ContactsActivity implements
    ...
    public boolean getLocal(){
        ...
        if (language.equalsIgnoreCase(app.getSystemLanguage())){
        	return true;
        }else{
        	app.setSystemLanguage(language);
        	return false;
        }
    }
    
    boolean sIsRunningNumberCheck = false;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
              if (sIsRunningNumberCheck) {
                ...
                Log.i(TAG, "uri = " + uri);
                Cursor groupCursor = getContentResolver().query(uri, new String[] { Groups._ID }, 
                		Groups.SYSTEM_ID + " in ( 501,502,503,504 ) ", null, null);
                try {
                    if (getLocal()) {
                        return;
                    } else {
                        ...
                        while(groupCursor.moveToNext()){
                        	int int1 = groupCursor.getInt(0);
                        	groupids.add(int1);
                        	Log.i("test","==这里是修改前的查询=="+int1);
                        	}
                      
                        ContentValues groupValues = new ContentValues();
                        for(int i = 0; i < defaultGroups.length; i++){
                            final String title = getResources().getString(defaultGroups[i][0]);
                            groupValues.put(Groups.TITLE,title);
                            builder.withSelection(Groups._ID + " = ? ", new String[]{String.valueOf(groupids.get(i))});
    ...
    protected void onNewIntent(Intent intent) {
		...
		//wangcunxi delete begin Care_os
        //mActionBarAdapter.initialize(null, mRequest);
        //wangcunxi delete end
        mContactListFilterController.checkFilterValidity(false);
...
//        }
        ...
        if (mRequest.getActionCode() == ContactsRequest.ACTION_VIEW_CONTACT) {
            ...
            final Intent redirect = new Intent(this, com.cappu.contacts.CareContactDetailActivity.class);
    ...
    private void createViewsAndFragments(Bundle savedState) {
		...
		//wangcunxi modify begin Care_os
        if(I99){
            setContentView(R.layout.care_people_activity);
            mSearchContent = findViewById(R.id.search_content);
            mSearchEdit = (EditText)findViewById(R.id.i99_search);
            ...
            mSearchEdit.addTextChangedListener(mI99TextWatcher);
        ...
        //wangcunxi add begin Cnext_OS(menu show)
    ...
    protected void onResume() {
        ...
        if(I99){
            ...
            I99Configure.updateFont(PeopleActivity.this);
    ...
    private class TabPagerAdapter extends PagerAdapter {
        ...
        public TabPagerAdapter() {
            ...
            /**in I99 we just set always search mode*/
            if(I99){
                //mTabPagerAdapterSearchMode = true;//dengying del
				//mActionBarAdapter.setSearchMode(true);//dengying del
            }
    ...
    private final class ContactBrowserActionListener implements OnContactBrowserActionListener {
        ...
        public void onViewContactAction(Uri contactLookupUri) {
            ...
            Intent intent = new Intent(PeopleActivity.this, com.cappu.contacts.CareContactDetailActivity.class);
            intent.setData(contactLookupUri);
            startActivity(intent);
            //wangcunxi modify end Care_OS
        }
...
//                break;
    ...
    public void onBackPressed() {
        Log.d(TAG, "[onBackPressed]");
		        ...
		        // add by y.haiyang for i99 (start)
        final String search = mSearchEdit.getText().toString().trim();
  ...
  // add by y.haiyang for i99 (start)
    private PopupWindow createSurNamePop(){
        ...
        //mSurNamePop.setBackgroundDrawable(getResources().getDrawable(R.drawable.i99_surname_bg));
        //mSurNamePop.setFocusable(true);
        mSurNamePop.setOutsideTouchable(true);//yuan tong qin add
        return mSurNamePop;
    }
    ...
    public void updateFilter(){
        ...
        mSearchEdit.setText(EMPTY);
        mSearchEdit.setText(mSearchString);
    }
    ...
    private class I99ClickListener implements View.OnClickListener{
            ...
            switch(v.getId()){
                case R.id.i99_surnames :
                    ...
                    if(mSurNamePop.isShowing()){
                        ...
                        mSurNamePop.showAsDropDown(mSearchContent, I99Utils.getScreenSize(PeopleActivity.this)[0] - width, 0);
                        hideKeyBoard();
                    }
                break;
    ...
    //private class SurNameFilterCallBack implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
            ...
            String[] projection = { ContactsContract.Contacts._ID,
                    ...
                    ContactsContract.Contacts.SORT_KEY_PRIMARY ,"phonebook_label" };//yuan tong qin add phonebook_label

            return new CursorLoader(PeopleActivity.this, Contacts.CONTENT_URI,
...
//                String letter = sortKey.substring(0, 1);//yuan tong qin add 
            ...
            SurnamesListAdapter mSurListAdapter = new SurnamesListAdapter(PeopleActivity.this,mSurNameFilters);
            mSurNameList.setAdapter(mSurListAdapter);
            mSurListAdapter.setCallBack(mSurCallBack);
    ...
    SurnamesCallBack mSurCallBack = new SurnamesCallBack(){
        @Override
        public void showSurGrid(FilterNodes filter ,boolean add){
            ...
            SurnamesGridAdapter mGridAdapter = new SurnamesGridAdapter(PeopleActivity.this, filter.getChildren());
            mSurNameGrid.setAdapter(mGridAdapter);
            mGridAdapter.setCallBack(mSurCallBack);
            if(add){
        ...
        public void updateFilter(FilterNodes filter){
            mSearchString=I99Utils.plusString(mSearchString,filter.getData());
            PeopleActivity.this.updateFilter();
        }
    };

    private void showOptionDialog(){
        mOptionDialog = new CareMenu(PeopleActivity.this);
        mOptionDialog.setTitle(R.string.i99_option);
        mOptionDialog.addButton(R.string.i99_new_contact);
        //mOptionDialog.addButton(R.string.i99_title_group);//dengying del
        mOptionDialog.addButton(R.string.i99_delete_contact);
        mOptionDialog.addButton(R.string.i99_import_export_contacts);
        mOptionDialog.setOnClickListener(new CareMenu.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = null;
                switch(v.getId()){
                    case R.string.i99_new_contact:
                        intent = new Intent("com.android.contacts.action.FULL_INSERT", Contacts.CONTENT_URI);//dengying modify
                        startActivity(intent);
                        break;
                    case R.string.i99_title_group:
                        intent = new Intent(PeopleActivity.this,I99PhoneBookActivity.class);
                        startActivity(intent);
                        break;
                    case R.string.i99_delete_contact:
					    //denying del
                    	/*
                        intent = new Intent(com.mediatek.contacts.util.ContactsIntent.LIST.ACTION_DELETE_MULTICONTACTS);
                        intent.setClassName(getApplicationContext(),"com.mediatek.contacts.list.ContactListMultiChoiceActivity");
                        startActivity(intent);*/
                        ...
                        startActivity(new Intent().setClassName(getApplicationContext(),
                                ...
                                com.mediatek.contacts.util.ContactsIntent.LIST.ACTION_DELETE_MULTI_CONTACTS));//dengying add
                        
                        break;
                    case R.string.i99_import_export_contacts:
                         //importContact(); //dengying del
                    	     ActivitiesUtils.doImportExport(PeopleActivity.this);
                        break;
                }
            }
    ...
    private void hideKeyBoard(){
        ...
        imm.hideSoftInputFromWindow(PeopleActivity.this.getCurrentFocus().getWindowToken(), InputMethodManager.RESULT_UNCHANGED_SHOWN);
    }
    ...
    private onTopBarListener mTopBarListener = new onTopBarListener(){
        ...
        public void onTitleClick(View v){
            AccountFilterUtil.startAccountFilterActivityForResult(
                        PeopleActivity.this, SUBACTIVITY_ACCOUNT_FILTER,
                        mContactListFilterController.getFilter());
        }
    };
    ...
    public void updateSubTitle(){
        ...
        mTopBar.setSubText(getFilterString(filter));
    }

    public String getFilterString(ContactListFilter filter){
        String format = null ;
        int filterType = (filter != null) ?
            filter.filterType:
            ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS;
        ...
        switch (filterType) {
            case ContactListFilter.FILTER_TYPE_ACCOUNT:
                if (AccountType.ACCOUNT_NAME_LOCAL_PHONE.equals(filter.accountName)) {
                    format = getString(R.string.phone_contact);
                }else {
                    String displayName = AccountFilterUtil.getAccountDisplayNameByAccount(filter.accountType, filter.accountName);
                    if(TextUtils.isEmpty(displayName)){
                        format = filter.accountName;
                    }else{
                        format = displayName;
                    }
                }
            ...
            case ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS:
                format = getString(R.string.all_contact);
                break;
            case ContactListFilter.FILTER_TYPE_CUSTOM:
                format = getString(R.string.custom_contact);
                break;
            default:
                format = getString(R.string.others_contact,filter.displayName);
                break;
        }
        return format;
    }
