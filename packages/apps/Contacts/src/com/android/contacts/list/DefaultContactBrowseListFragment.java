...
import com.cappu.contacts.I99CustomerServiceActivity;//wangcunxi modify
...
public class DefaultContactBrowseListFragment extends ContactBrowseListFragment {
    ...
    private TextView mProfileMessage;//wangcunxi modify
    ...
    protected ContactListAdapter createListAdapter() {
    	 ...
    	 android.util.Log.e("dengyingContactList", "DefaultContactBrowseListFragment.java new DefaultContactListAdapter");
    ...
    protected View inflateView(LayoutInflater inflater, ViewGroup container) {
        ...
        return inflater.inflate(R.layout.care_contact_list_content, null);
    ...
    private void addEmptyUserProfileHeader(LayoutInflater inflater) {
        ...
        mProfileHeader = inflater.inflate(R.layout.care_user_profile_header, null, false);
        //wangcunxi modify end
        ...
        mProfileMessage = (TextView) mProfileHeader.findViewById(R.id.user_profile_button);//wangcunxi modify
        mProfileMessage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
			   ...
			   Intent intent = new Intent(getActivity(), I99CustomerServiceActivity.class);
               startActivity(intent);
               //wangcunxi modify end
