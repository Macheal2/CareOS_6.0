...
import com.cappu.app.CareDialog;  //yuan tong qin add 
...
public class ImportVCardActivity extends Activity {
    ...
    private CareDialog mVcardFileSelectDialog;
    ...
    private Dialog getSelectImportTypeDialog() {
        ...
        final CareDialog.Builder builder = new CareDialog.Builder(this)
    ...
    private Dialog getVCardFileSelectDialog(boolean multipleSelect) {
        ...
        final CareDialog.Builder builder =
    ...
    protected Dialog onCreateDialog(int resId, Bundle bundle) {
        switch (resId) {
            ...
            case R.id.dialog_select_multiple_vcard: {
                ...
                mVcardFileSelectDialog = (CareDialog) getVCardFileSelectDialog(true);
