...
public final class AccountsListAdapter extends BaseAdapter {
    ...
    public AccountsListAdapter(Context context, AccountListFilter accountListFilter,
        ...
        java.util.Collections.reverse(mAccounts);
		//wangcunxi add end
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //text1.setText(accountType.getDisplayLabel(mContext));//wangcunxi modify Care_os

        // For email addresses, we don't want to truncate at end, which might cut off the domain
        // name.
        /// M: add for sim name
        AccountsListAdapterUtils.getViewForName(mContext, account, accountType, text1, icon);//wangcunxi modify Care_os
