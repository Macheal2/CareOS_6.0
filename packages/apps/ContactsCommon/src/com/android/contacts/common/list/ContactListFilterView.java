    ...
    public void bindView(AccountTypeManager accountTypes) {
        ...
        switch (mFilter.filterType) {
            case ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS: {
                // modify by wangcunxi for care os (start)
                bindView(R.drawable.care_ic_all_contact, R.string.list_filter_all_accounts);
                // modify by wangcunxi for care os (end)
                break;
            }
            ...
            case ContactListFilter.FILTER_TYPE_CUSTOM: {
                // modify by wangcunxi for care os (start)
                bindView(R.drawable.care_ic_custom, R.string.list_filter_customize);
                // modify by wangcunxi for care os (end)
                break;
            }
            ...
            case ContactListFilter.FILTER_TYPE_ACCOUNT: {
                ...
                if (accountType.isIccCardAccount()) {
                    ...
                    mIcon.setImageResource(R.drawable.i99_sim);// modify by wangcunxi 
                } else {
