        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    protected void onCreate(Bundle icicle) {
         ...
         */
        View listLayout = getLayoutInflater().inflate(R.layout.care_contact_list_filter_custom, null);
        setContentView(R.layout.care_contact_list_filter_custom);
        getActionBar().hide();
        ...
        // remove by y.haiyang for care os (start)
        /**
             * findViewById(R.id.btn_done).setOnClickListener(this);
             * findViewById(R.id.btn_discard).setOnClickListener(this);
             */
        // remove by y.haiyang for care os (end)
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(
                        R.layout.care_custom_contact_list_filter_account, parent, false);
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(
                        R.layout.care_custom_contact_list_filter_group, parent, false);
                //wangcunxi modify end
            }
