...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    //hide by hmq 20161108 Modify for cappu pictorial
...
//            KEY_TOGGLE_INSTALL_APPLICATIONS };
    ...
    private static final String KEY_AUTO_PICTORIAL = "auto_pictorial";
    private static final String KEY_RANDOM_PICTORIAL = "random_pictorial";
    private SwitchPreference mAutoPictorial;
    private SwitchPreference mRandomPictorial;
    private static final String SWITCH_PREFERENCE_KEYS[] = { KEY_LOCK_AFTER_TIMEOUT,
            KEY_VISIBLE_PATTERN, KEY_POWER_INSTANTLY_LOCKS, KEY_SHOW_PASSWORD,
            KEY_TOGGLE_INSTALL_APPLICATIONS, KEY_AUTO_PICTORIAL, KEY_RANDOM_PICTORIAL };
    ...
    private static int getResIdForLockUnlockScreen(Context context,
        ...
        if (!lockPatternUtils.isSecure(MY_USER_ID)) {
            ...
            // added by yzs for Duplicate begin 20150820
            }else if (lockPatternUtils.getDuplicateLockScreenEnabled()) {
                if(lockPatternUtils.getDuplicateLockStyle() == 0){
                    resid = R.xml.security_settings_magcommlocker;
                }else {
                    resid = R.xml.security_settings_cappulocker;
                }
            }
            //added by yzs for Duplicate  end
            else {
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        // added by yzs begin for Duplicate 20150820
        if (mLockPatternUtils.isSecure(MY_USER_ID)
                || mLockPatternUtils.usingBiometricWeak()) {
            mLockPatternUtils.setDuplicateLockScreenEnabled(false);
        }
        // added by yzs for Duplicate end
...
//        }
        ...
        /* begin: edit by hmq 20161108 Modify for cappu pictorial */
        mAutoPictorial = (SwitchPreference) root.findPreference(KEY_AUTO_PICTORIAL);
        mRandomPictorial = (SwitchPreference) root.findPreference(KEY_RANDOM_PICTORIAL);
        if (resid == R.xml.security_settings_magcommlocker || resid == R.xml.security_settings_cappulocker) {
            if (securityCategory != null && mAutoPictorial != null && mRandomPictorial != null){
                if(SystemProperties.getInt("ro.com.cappu.keyguard.pictorial",0) != 1){
                    securityCategory.removePreference(mAutoPictorial);
                    securityCategory.removePreference(mRandomPictorial);
                    mAutoPictorial = null;
                    mRandomPictorial = null;
                }
            }
        }
        /* end: edit by hmq 20161108 Modify for cappu pictorial */
    ...
    public void onResume() {
        ...
        /* begin: edit by hmq 20161108 Modify for cappu pictorial */
        if (mAutoPictorial != null){
            int mode = Settings.System.getInt(getContentResolver(), Settings.System.CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL, Settings.System.CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL_ON);
            mAutoPictorial.setChecked(mode == Settings.System.CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL_ON);
        }
        
        if (mRandomPictorial != null){
            int mode = Settings.System.getInt(getContentResolver(), Settings.System.CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL, Settings.System.CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL_OFF);
            mRandomPictorial.setChecked(mode == Settings.System.CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL_ON);
        }
        /* begin: edit by hmq 20161108 Modify for cappu pictorial */
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        /* begin: edit by hmq 20161108 Modify for cappu pictorial */
        if (SystemProperties.getInt("ro.com.cappu.keyguard.pictorial", 0) == 1) {
            if (KEY_AUTO_PICTORIAL.equals(key)) {
                boolean auto = (Boolean) value;
                Settings.System.putInt(getContentResolver(), Settings.System.CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL, auto ? Settings.System.CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL_ON : Settings.System.CAPPU_SETTINGS_SYSTEM_AUTO_PICTORIAL_OFF);
            } else if (KEY_RANDOM_PICTORIAL.equals(key)) {
                boolean auto = (Boolean) value;
                Settings.System.putInt(getContentResolver(), Settings.System.CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL, auto ? Settings.System.CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL_ON : Settings.System.CAPPU_SETTINGS_SYSTEM_RANDOM_PICTORIAL_OFF);
            }
        }
        /* end: edit by hmq 20161108 Modify for cappu pictorial */
        return result;
