...
/* Cappu:lau on: Mon, 24 Jul 2017 14:33:37 +0800
...
/* Cappu:lau on: Mon, 24 Jul 2017 14:33:37 +0800
 * TODO: remove xunfei in Settings Applications
 */
            //liukun
            List<String> hideApps = Arrays.asList("com.baidu.map.location");
            ...
            for(int i=0;i<origEntries.size();i++){ 
                ...
                String nlabel = entry.info.packageName;
                if(hideApps.contains(nlabel)){
                    origEntries.remove(entry);
                }
            }
