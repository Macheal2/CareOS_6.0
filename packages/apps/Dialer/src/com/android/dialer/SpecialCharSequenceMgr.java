...
//modify by even
    //start
    private static final String MMI_MOBILE_DEMO_VALUE = "77"; 
    private static final String MMI_MOBILE_DEMO_CANCEL_VALUE = "99"; 
	private static final String MMI_MOBILE_DEMO = "*#*#77#*#*"; 
	private static final String MMI_MOBILE_DEMO_CANCEL = "*#*#99#*#*"; 
    //end
    /**
    ...
    //modify by even
    //start
    public static boolean handleMobileDemo(Context context, String input) {
		
		//if (input.equals(MMI_MOBILE_DEMO)) 
		//{
		   
		    Log.e(TAG, "EVEN:MMI_MOBILE_DEMO");
            Intent i = new Intent(Intent.ACTION_MAIN);
            ComponentName cn = new ComponentName("com.cappu.launcherwin","com.cappu.launcherwin.Launcher");//change package and class name by zxy for launcherCarousel
            i.setComponent(cn);
            i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            i.putExtra("mobile_demo", 1);
    ...
    public static boolean CancelMobileDemo(Context context, String input) {
		
		//if (input.equals(MMI_MOBILE_DEMO_CANCEL)) 
		//{
		   
		    Log.e(TAG, "EVEN:MMI_MOBILE_DEMO_CANCEL");
            Intent i = new Intent(Intent.ACTION_MAIN);
            ComponentName cn = new ComponentName("com.cappu.launcherwin","com.cappu.launcherwin.Launcher");//change packages and class name by zxy for launcherCarousel
            i.setComponent(cn);
            i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            i.putExtra("mobile_demo", 2);
            context.startActivity(i);
			return true;
	    //} 
    ...
    public static boolean handleChars(Context context, String input, EditText textField) {
        ...
        if (handleDeviceIdDisplay(context, dialString)
                //|| handleMobileDemo(context, dialString) //modify by even
                //|| CancelMobileDemo(context, dialString) //modify by even
    ...
    static boolean handleSecretCode(Context context, String input) {
        ...
        if (len > 8 && input.startsWith("*#*#") && input.endsWith("#*#*")) {
			...
			//modify by even 
			//start
			Log.e(TAG, "EVEN:handleSecretCode input.substring(4, len - 4) = " + input.substring(4, len - 4));
			if(MMI_MOBILE_DEMO_VALUE.equals(input.substring(4, len - 4)))
			{
				handleMobileDemo(context, input.substring(4, len - 4));
			}else if(MMI_MOBILE_DEMO_CANCEL_VALUE.equals(input.substring(4, len - 4)))
			{
				CancelMobileDemo(context, input.substring(4, len - 4));
			}else //end
			{
    ...
    static boolean handleDeviceIdDisplay(Context context, String input) {
        ...
        if (telephonyManager != null && input.equals(MMI_IMEI_DISPLAY)) {
            ...
            int labelResId = R.string.mobile_identity_code;
