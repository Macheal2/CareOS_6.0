...
public final class CallLogListItemViewHolder extends RecyclerView.ViewHolder
    ...
    public void inflateActionViewStub() {
        ...
        if (stub != null) {
            ...
            //dengying 通话记录的item action：打电话，发短信，详情等 
            ...
            if (canPlaceCallToNumber) {
                ...
                if (DialerFeatureOptions.isSuggestedAccountSupport()) {
                    primaryActionButtonView.setTag(IntentProvider
                            .getSuggestedReturnCallIntentProvider(number, accountHandle));
                /// @}
                ...
                if (DialerFeatureOptions.isImsCallSupport()
                    ...
                    primaryActionButtonView.setTag(
                            IntentProvider.getReturnIMSCallIntentProvider(number));
                }
                /** @} */
    ...
    public void showActions(boolean show) {
        ...
        if (show) {
            ...
            startActivityForAction(detailsButtonView);//dengying add
        } else {
	...
	public void bindimage(int callType) {
		ImageView image = (ImageView) rootView.findViewById(R.id.imageview_contact_photo);
		int resId = R.drawable.i99_ic_call_missed_bg;

		android.util.Log.i("dengyingContact", "CallLogListItemViewHolder.java bindimage callType="+callType);
		
		switch (callType) {
		case Calls.INCOMING_TYPE:
			resId = R.drawable.i99_ic_call_incoming_bg;
			break;
		case Calls.OUTGOING_TYPE:
			resId = R.drawable.i99_ic_call_outgoing_bg;
			break;
		case Calls.MISSED_TYPE:
			resId = R.drawable.i99_ic_call_missed_bg;
			break;
		case Calls.VOICEMAIL_TYPE:
			resId = R.drawable.ic_call_voicemail_holo_dark;
			break;
		// / M: for AutoRejct @{ auto_reject_type
		case Calls.AUTO_REJECT_TYPE:
			resId = R.drawable.mtk_ic_call_autorejected_holo_dark;
			break;
		default:
			resId = R.drawable.mtk_ic_call_autorejected_holo_dark;
		}
    ...
    public void setPhoto(long photoId, Uri photoUri, Uri contactUri, String displayName,
        ...
        /// M:[Union Query] if this contact is SIM contact,call log need show SIM icon @{
        if (info != null && DialerFeatureOptions.CALL_LOG_UNION_QUERY) {
    ...
    public void onClick(View view) {
    	...
    	android.util.Log.e("dengying","CallLogListItemViewHolder.java onClick");
