...
public final class CallLogQuery {
    /// M: [Union Query] for MTK CallLog query, rename
    ...
    public static final int NUMBER_PRESENTATION =
            DialerFeatureOptions.CALL_LOG_UNION_QUERY ? 9 : 17;
    public static final int ACCOUNT_COMPONENT_NAME =
            DialerFeatureOptions.CALL_LOG_UNION_QUERY ? 10 : 18;
    ...
    public static final int CACHED_PHOTO_URI = 23; // This is only used without union query feature
    ...
    public static final String[] UNION_PROJECTION =  new String[] {
        ...
        Data.PHOTO_URI,                     // 24
        RawContacts.IS_SDN_CONTACT,         // 25
        /// M: [VoLTE ConfCallLog] For Volte conference call calllog @{
        Calls.CONFERENCE_CALL_ID,           // 26
        Calls.SORT_DATE                     // 27
        /// @}
    };
    ...
    public static final int CALLS_JOIN_DATA_VIEW_IS_SDN_CONTACT = 25;
    /// M: [VoLTE ConfCallLog] For Volte conference call calllog.
    public static final int CONFERENCE_CALL_ID =
            DialerFeatureOptions.CALL_LOG_UNION_QUERY ? 26 : 24;
    /// @}
}
