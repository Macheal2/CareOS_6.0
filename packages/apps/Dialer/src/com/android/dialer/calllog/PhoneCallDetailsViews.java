...
public final class PhoneCallDetailsViews {
    ...
    public final View callInfoBg;
    public final View namecount;
    //yuan tong qin add end

    private PhoneCallDetailsViews(TextView nameView, View callTypeView,
            CallTypeIconsView callTypeIcons, TextView callLocationAndDate,
            TextView voicemailTranscriptionView, TextView callAccountLabel,View callInfoBg,View namecount) {
        ...
        //yuan tong qin add begin
        this.callInfoBg=callInfoBg;//设置背景
        this.namecount=namecount;//设置宽度
        //yuan tong qin add end
    }
    ...
    public static PhoneCallDetailsViews fromView(View view) {
        return new PhoneCallDetailsViews((TextView) view.findViewById(R.id.name),
                ...
                //yuan tong qin modify begin
                (TextView) view.findViewById(R.id.call_account_label),
                view.findViewById(R.id.calllog_item_info_line),
                view.findViewById(R.id.name_count)
