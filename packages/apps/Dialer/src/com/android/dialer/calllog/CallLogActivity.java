...
public class CallLogActivity extends Activity implements
    ViewPager.OnPageChangeListener, /*M:*/ICallLogAction, /*M:*/AccountInfoListener ,View.OnClickListener{
...
//       
        ...
        Button mContactBu=(Button) findViewById(R.id.i99_call_log_contact);
        mContactBu.setOnClickListener(this);
        
        Button mDialpadBu=(Button) findViewById(R.id.i99_call_log_dialpad);
        mDialpadBu.setOnClickListener(this);
        
        // yuan tong qin add end 

        //mViewPagerTabs.setViewPager(mViewPager);//yuan tong qin del 
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        //mViewPagerTabs.onPageScrolled(position, positionOffset, positionOffsetPixels);//yuan tong qin del 
    }
    ...
    public void onPageSelected(int position) {
        ...
        //mViewPagerTabs.onPageSelected(position);//yuan tong qin del 
    }

    @Override
    public void onPageScrollStateChanged(int state) {
        //mViewPagerTabs.onPageScrollStateChanged(state); //yuan tong qin del 
    }
    ...
    private OptionDialog getOptionDialog(){
        if(mOptionDialog == null){
            mOptionDialog = new OptionDialog(CallLogActivity.this);
            mOptionDialog.setTitle(R.string.i99_option);
            mOptionDialog.addButton(R.string.delete_calllogs);
            mOptionDialog.setOnClickListener(mOptionListener);
        }
    ...
    //跳到删除页面去
    private OptionDialog.OnClickListener mOptionListener = new OptionDialog.OnClickListener(){
        public void onClick(View v){
            Intent intent = new Intent(CallLogActivity.this, CallLogMultipleDeleteActivity.class);
	...
	public void onClick(View arg0) {
    	 Intent intent = null ;
		switch(arg0.getId()){
		case R.id.i99_call_log_contact:
			 intent = new Intent();
			 intent.setClassName("com.android.contacts","com.android.contacts.activities.PeopleActivity");
             CallLogActivity.this.startActivity(intent);
			break;
		case R.id.i99_call_log_dialpad:
			intent = new Intent(CallLogActivity.this , DialtactsActivity.class);
			intent.putExtra("calldetailTodialpad", "yes");
			CallLogActivity.this.startActivity(intent);
			break;
		}
	}
