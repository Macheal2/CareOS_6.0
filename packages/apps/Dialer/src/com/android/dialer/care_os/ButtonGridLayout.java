...
public class ButtonGridLayout extends FrameLayout {
    ...
    // add by y.haiyang for i99(start)
    private static final boolean I99 = true;//I99Configure.USED_I99;
    // add by y.haiyang for i99 (end)
    ...
    //这个方法是在ondraw方法之前执行，是加载资源xml等
    @Override
    protected void onFinishInflate() {
        super.onFinishInflate();
        // add by y.haiyang for i99 (start)
        /** if i99  just  run  layout*/
        if(I99){
            LayoutInflater.from(getContext()).inflate(R.layout.i99_diapad_number_layout, this);
        }else{
    ...
    */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // remove by y.haiyang for i99 (start)
        /**
        ...
        */
        ...
        // remove by y.haiyang for i99(end)
    }
}
