...
public class DialerPhoneNumberListAdapter extends PhoneNumberListAdapter {
    ...
    private void initResources(Context context) {
        ...
        mCallTypeDrawables.put(Calls.INCOMING_TYPE, context.getResources().getDrawable(R.drawable.mtk_ic_call_incoming_holo_dark));
        mCallTypeDrawables.put(Calls.OUTGOING_TYPE, context.getResources().getDrawable(R.drawable.mtk_ic_call_outgoing_holo_dark));
        mCallTypeDrawables.put(Calls.MISSED_TYPE, context.getResources().getDrawable(R.drawable.mtk_ic_call_missed_holo_dark));
        mCallTypeDrawables.put(Calls.VOICEMAIL_TYPE, context.getResources().getDrawable(R.drawable.mtk_ic_call_voicemail_holo_dark_red));
