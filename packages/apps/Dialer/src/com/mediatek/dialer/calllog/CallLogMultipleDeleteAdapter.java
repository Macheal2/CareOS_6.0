...
import android.widget.LinearLayout.LayoutParams;//yuan tong qin add
...
public class CallLogMultipleDeleteAdapter extends CallLogAdapter {
    ...
    private Context mContext;//yuan tong qin add
    ...
    public CallLogMultipleDeleteAdapter(Context context, CallFetcher callFetcher,
        ...
        this.mContext=context;//yuan tong qin add
    }
    ...
    protected void bindCallLogListViewHolder(ViewHolder viewHolder, int position) {
        ...
        View namecount=views.rootView.findViewById(R.id.name_count);
        int width=mContext.getResources().getDisplayMetrics().widthPixels;

        namecount.setLayoutParams(new LayoutParams(1*width/2, LayoutParams.MATCH_PARENT));
