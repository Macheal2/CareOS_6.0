...
public class CallCardPresenter extends Presenter<CallCardPresenter.CallCardUi>
    ...
    public void onStateChange(InCallState oldState, InCallState newState, CallList callList) {
        ...
        if (newState == InCallState.INCOMING) {
            ...
            ui.setIncomingCallButtonVisible(true);
            ui.setInCallButtonVisible(false);
            ...
            //caiji add for Care_OS
            ui.setIncomingCallButtonVisible(false);
            ui.setInCallButtonVisible(true);
        ...
        if (mPrimary != null && (primaryChanged ||
            ...
            if (previousPrimary != null) {
                /// M: clear progress spinner (if any) related to previous primary call @{
    ...
    private void updatePrimaryCallState() {
        ...
        if (getUi() != null && mPrimary != null) {
            ...
            /**
             * M: [ALPS02280888]Show HD icon if the call is a VoLTE call. @{
             * TODO: VoLTE != HD. So we should do a separate way in future.
             */
            showHdAudioIndicator |=
                    isPrimaryCallActive() && mPrimary.hasProperty(Details.PROPERTY_VOLTE);
            /** @} */
    ...
    private void updatePrimaryDisplayInfo() {
        ...
        if (mPrimary.isConferenceCall()) {
            ...
            ui.setPrimary(
                    ...
                    null,//mPrimaryContactInfo.label,
    ...
    private void updateSecondaryDisplayInfo() {
        ...
        if (mSecondary == null) {
            ...
            ui.setSecondary(false, null, false, null, null, false /* isConference */
                    , false /* isVideoCall */, null);//caiji add photo for Care_OS Secondary call
            return;
        }
        ...
        if (mSecondary.isConferenceCall()) {
            ui.setSecondary(
                    ...
                    true /* isConference */,
                    mSecondary.isVideoCall(mContext),null);//caiji add photo for Care_OS Secondary call
            ...
            ui.setSecondary(
                    ...
                    getCallProviderLabel(mSecondary),
                    false /* isConference */,
                    mSecondary.isVideoCall(mContext),mSecondaryContactInfo.photo);//caiji add photo for Care_OS Secondary call

            /// Fix ALPS01768230.
            /// Can't swipe calls when primary call's in intermediate video session state @{
...
//caiji add for Care_OS
    public void answerCallClicked() {
        ...
        CallList.getInstance().onUpdate(mPrimary);
        TelecomAdapter.getInstance().answerCall(id,0);
    }
    ...
    public interface CallCardUi extends Ui {
        ...
        /// @}
		    //caiji add for Care_OS
        void setIncomingCallButtonVisible(boolean visible);
        void setInCallButtonVisible(boolean visible);
        void updateForDialpad();
        void setSecondary(boolean show, String name, boolean nameIsNumber, String label,
                String providerLabel, boolean isConference, boolean isIncoming, Drawable photo);
