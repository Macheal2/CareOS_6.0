...
import com.cappu.app.CareDialog;//caiji add for Care_OS
/**
...
public class InCallActivity extends Activity implements FragmentDisplayManager {
    ...
    protected void onResume() {
        ...
        intent.setAction("com.android.incallui.IsForeground");
...
//		            if ((System.currentTimeMillis() - mHangupTime) > 2000) {
//		                LayoutInflater inflate = LayoutInflater.from(InCallActivity.this);
//		                View v = inflate.inflate(R.layout.mag_end_call_noti, null);
//		                final int h = CareUtils.getScreenSize(InCallActivity.this)[1];
//		                Toast toast = new Toast(InCallActivity.this);
//		                toast.setDuration(Toast.LENGTH_SHORT);
//		                toast.setGravity(Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, h/4);
//		                toast.setView(v);
//		                toast.show();
//		                mHangupTime = System.currentTimeMillis();
//		            } else {
...
//                break;
            // caiji add home key notice for incallui (end)
            // caiji add for dismiss key back (start)
            case KeyEvent.KEYCODE_BACK:
                return true;
            // caiji add for dismiss key back (end)
    ...
    private void showErrorDialog(CharSequence msg) {
        ...
        dismissPendingDialogs();
        //caiji modify for Care_OS
        mDialog = new CareDialog.Builder(this)
                .setMessage(msg)
    ...
    public void showStorageFullDialog(final int resid, final boolean isSDCardExist) {
        ...
        //caiji modify for Care_OS				
        CareDialog.Builder dialogBuilder = new CareDialog.Builder(this).setMessage(msg)
