...
/* caiji modify for Care_OS start */
/*
...
final View parent = inflater.inflate(
                com.android.incallui.R.layout.mag_dtmf_twelve_key_dialer_view, container, false);
        mDialpadView = (DialpadView) parent.findViewById(R.id.mag_incall_dialpad_view);
        /* caiji modify for Care_OS end */
    ...
    public void animateShowDialpad() {
        ...
        final DialpadView dialpadView = (DialpadView) getView().findViewById(R.id.mag_incall_dialpad_view);
        /* caiji modify for Care_OS end */
