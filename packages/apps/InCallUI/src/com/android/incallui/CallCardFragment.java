...
//import com.android.contacts.common.widget.FloatingActionButtonController;//hejianfeng delete
...
import android.graphics.Color;//modify by even
/**
...
//    private FloatingActionButtonController mFloatingActionButtonController;//hejianfeng delete
...
//caiji add for Care_OS
    private CallButtonFragment mCallButtonFragment;
    private ImageView mPhotoBg;
    private View mInCallButton;
    private View mIncomingCallButton;
    private View mIncomingCallAnswer;
    private View mIncomingCallEnd;

    //modify by even
    private boolean mNameisNumber;
    ///@}
    @Override
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mNameisNumber = false; //modify by even
...
//caiji add for Care_OS
        mPhotoBg = (ImageView) view.findViewById(R.id.photo_bg);      
        mInCallButton = view.findViewById(R.id.inCallButton);
        mIncomingCallButton = view.findViewById(R.id.incomingCallButton);
        mIncomingCallAnswer = view.findViewById(R.id.incomingCallAnswer);
        mIncomingCallEnd= view.findViewById(R.id.incomingCallEnd);
        mCallButtonFragment = (CallButtonFragment) this.getChildFragmentManager()
                .findFragmentById(R.id.callButtonFragment);
        mIncomingCallEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            	//mCallButtonsContainer.setVisibility(View.GONE);	//modified by Yar @20170817
                getPresenter().endCallClicked();
            }
        });
        mIncomingCallAnswer.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                getPresenter().answerCallClicked();
            }
        });
...
//caiji add for Care_OS
    public void updateForDialpad() {
        if (mCallButtonFragment != null) {
            if(mIsDialpadShowing){
                mPrimaryCallInfo.setVisibility(View.GONE);
                mPhotoBg.setVisibility(View.GONE);
		   if (mSecondaryCallInfo != null) {
	                mSecondaryCallInfo.setVisibility(View.GONE);
        	   }
            }else{
                mPrimaryCallInfo.setVisibility(View.VISIBLE);
                mPhotoBg.setVisibility(View.VISIBLE);
		   if (mSecondaryCallInfo != null) {
	                mSecondaryCallInfo.setVisibility(View.VISIBLE);
        	   }
            }
            setPhotoVisible(!mIsDialpadShowing);
        }
    }

    public void setInCallButtonVisible(boolean visible) {
        mInCallButton.setVisibility(visible ? View.VISIBLE : View.GONE);
    }

    public void setIncomingCallButtonVisible(boolean visible) {
        mIncomingCallButton.setVisibility(visible ? View.VISIBLE : View.GONE);
    }
    @Override
    ...
    public void setPrimary(String number, String name, boolean nameIsNumber, String label,
        ...
        if (TextUtils.isEmpty(number) && TextUtils.isEmpty(label)) {
            ...
            mElapsedTime.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
        } else {
    ...
    public void setSecondary(boolean show, String name, boolean nameIsNumber, String label,
        ...
        if (show) {
            ...
            int resId = isTwoIncoming ? R.string.notification_incoming_call
        ...
        /// M: [1A1H2W] update secondary view position.
        updateSecondaryCallInfoPosition();
    }
	 //caiji add for Care_OS Secondary call 
    @Override
    public void setSecondary(boolean show, String name, boolean nameIsNumber, String label,
            String providerLabel, boolean isConference, boolean isVideoCall, Drawable photo) {

        if (show != mSecondaryCallInfo.isShown()) {
            updateFabPositionForSecondaryCallInfo();
        }
setDrawableToImageView(mSecondaryCallInfo.mCallSecondaryPhoto, photo);
        if (show) {
            // M: FIXME: this plugin usage is not correct.
            // M: add for OP09 plug in @{
            if (ExtensionManager.getCallCardExt().shouldShowCallAccountIcon()) {
...
if(TextUtils.equals(callStateLabel.getCallStateLabel(),(getView().getContext().getString(R.string.card_title_incoming_call_UNKNOWN))))
            {
                //modify by even
                Log.d(this, "setTextColor(Color.RED)");
                mCallStateLabel.setTextColor(Color.RED);//red 
            }else{
                mCallStateLabel.setTextColor(Color.WHITE);//white
            }
            ...
            case Call.State.CALL_WAITING:
               ...
               /// @}
                ...
                if (isWifi && hasSuggestedLabel) {
                    ...
                    if(mNameisNumber)
                    {
                        callStateLabel = context.getString(R.string.card_title_incoming_call_UNKNOWN);
                    }
                }
                break;
    ...
    public void animateForNewOutgoingCall() {
        ...
        observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                // Set up FAB.
                Log.v(this, "onGlobalLayout jeff ,");
              //hejianfeng delete
//                mFloatingActionButtonContainer.setVisibility(View.GONE);
...
/**
    ...
    /**
     * M: [1A1H2W]If exsit 2W or from 2W to 1W, update the mSecondaryCallInfo view position.
     */
    private void updateSecondaryCallInfoPosition() {
        int bottomPadding = 0;
