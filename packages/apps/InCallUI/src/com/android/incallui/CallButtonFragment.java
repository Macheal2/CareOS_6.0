...
public class CallButtonFragment
    ...
    public interface Buttons {
        ...
        public static final int BUTTON_RECOED = 19;
        //hejianfeng add end 
        /// @}
        public static final int BUTTON_COUNT = 20;//hejianfeng modif
    }
...
//caiji add for Care_OS
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		//caiji add for Care_OS
        mHomeButton = (ImageButton) parent.findViewById(R.id.homeButton);
...
//caiji add for Care_OS
            ...
            case R.id.recordButton: 
				//caiji fix bug for click record button quickly
...
//caiji add for Care_OS start
	//caiji fix bug for click record button quickly start
	...
	//caiji fix bug for click record button quickly end
	
    private void magRecordClicked() {
        Log.d(this, "magRecordClicked");
...
//caiji add for Care_OS end
    ...
    public void updateColors() {
        ...
        View[] compoundButtons = {
                ...
                /// M: for call button feature. @{
				mRecordButton,//caiji add for Care_OS
                mRecordVoiceButton
                /// @}
        };
...
//caiji add for Care_OS
    ...
    public void setEnabled(boolean isEnabled) {
        ...
        /// @}
		//caiji add for Care_OS
        mHomeButton.setEnabled(isEnabled);      
    ...
    public void showButton(int buttonId, boolean show) {
    	//hejianfeng add start
    	if(buttonId !=BUTTON_AUDIO &&buttonId !=BUTTON_HOME&&buttonId !=BUTTON_RECOED&&buttonId !=BUTTON_DIALPAD){
    		show=false;
    	}
    	//hejianfeng add end
