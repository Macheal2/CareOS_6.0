...
public class CallInfoView extends FrameLayout {
    ...
    public ImageView mCallSecondaryPhoto;
    ...
    public CallInfoView(Context context, AttributeSet attrs) {
        ...
        inflate.inflate(R.layout.mag_call_info_view, this);
        ...
        //caiji add for Care_OS Secondary call 
        mCallSecondaryPhoto = (ImageView) findViewById(R.id.mag_secondary_call_info_photo);
    }
}
