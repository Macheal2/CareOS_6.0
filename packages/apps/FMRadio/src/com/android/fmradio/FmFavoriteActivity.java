...
public class FmFavoriteActivity extends Activity {
    ...
    // added by yzs begin
    public static final String ACTIVITY_CHANNEL_FREQ = "ACTIVITY_CHANNEL_FREQ";
    private static int mCurrentFreq = 0;// FMRadioUtils.DEFAULT_STATION;
    // added by yzs end
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setDisplayShowHomeEnabled(false);//added by yzs
        ...
        mCurrentFreq = this.getIntent().getIntExtra(ACTIVITY_CHANNEL_FREQ, mCurrentFreq);
    ...
    class MyFavoriteAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mCursor != null && mCursor.moveToFirst()) {
                ...
                if (stationFreq == mCurrentFreq){
                    viewHolder.mStationTypeView.setVisibility(View.VISIBLE);
                }else{
                    viewHolder.mStationTypeView.setVisibility(View.INVISIBLE);
                }
//                if (0 == isFavorite) {
...
//                });
    ...
    private void refreshList() {
        ...
        if (null != mService) {
            ...
            // If current location and last location exceed defined distance, delete
            // the RDS database
            if (isGpsOpen()) {
