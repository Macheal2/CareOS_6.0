...
public class ListAlbumSlidingWindow implements ListAlbumDataLoader.DataListener {
    @SuppressWarnings("unused")
    private static final String TAG = "Gallery2/ListAlbumSlidingWindow";
...
//        public void onGroupDataChanged(ArrayList<GroupData> item);
    ...
    private final ListAlbumDataLoader mSource;
    ...
    public ListAlbumSlidingWindow(AbstractGalleryActivity activity,
            ListAlbumDataLoader source, int cacheSize) {
    ...
    private class ThumbnailLoader extends BitmapLoader  {
        ...
        public void updateEntry() {
            ...
            /// M: [FEATURE.ADD] @{
            if (entry.item.getMediaData().mediaType == MediaData.MediaType.PANORAMA) {
	...
	@Override
	public void onDataChanged(ArrayList<ItemCoordinate> itemCoordinate,
			ArrayList<GroupData> iroupData) {
		// TODO Auto-generated method stub
		if (mListener != null) mListener.onDataChanged(itemCoordinate,iroupData);
...
//	public void onItemCoordinateChanged(ArrayList<ItemCoordinate> item) {
//		// TODO Auto-generated method stub
//		 if (mListener != null) mListener.onItemCoordinateChanged(item);
//	}
//
//	@Override
//	public void onGroupDataChanged(ArrayList<GroupData> item) {
//		// TODO Auto-generated method stub
//		 if (mListener != null) mListener.onGroupDataChanged(item);
//	}
}
