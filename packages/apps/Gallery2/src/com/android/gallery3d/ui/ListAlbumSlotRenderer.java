...
import com.android.gallery3d.app.ListAlbumDataLoader;
...
public class ListAlbumSlotRenderer extends ListAbstractSlotRenderer implements PlayEngine.OnFrameAvailableListener {
/// @}
    @SuppressWarnings("unused")
    private static final String TAG = "Gallery2/ListAlbumView";
    ...
    private static final int CACHE_SIZE =  FeatureConfig.sIsLowRamDevice ? 48 : 96;// //modify by even GalleryUtils.Is_Low_Ram_Device
    /// @}

    private ListAlbumSlidingWindow mDataWindow;
    private final AbstractGalleryActivity mActivity;
    private final ColorTexture mWaitLoadingTexture;
    private final ListSlotView mSlotView;
    ...
    public ListAlbumSlotRenderer(AbstractGalleryActivity activity, ListSlotView slotView,
        ...
        /// M: [FEATURE.ADD] VTSP @{
        mSupportVTSP = !FeatureConfig.sIsLowRamDevice;//modify by even
    ...
    public void setModel(ListAlbumDataLoader model) {
        if (mDataWindow != null) {
            mDataWindow.setListener(null);
            mSlotView.setSlotCount(0);
            mSlotView.onDataChanged(null, null);
//            mSlotView.setItemCoordinate(null);
//            mSlotView.setGroupData(null);
            mDataWindow = null;
        }
        if (model != null) {
            mDataWindow = new ListAlbumSlidingWindow(mActivity, model, CACHE_SIZE);
            mDataWindow.setListener(new MyDataModelListener());
//            mSlotView.setItemCoordinate(model.getItemCoordinate());       
//            mSlotView.setGroupData(model.getGroupData());
            Log.d("dengjianzhang7", "model.getGroupData()="+ model.size());
            mSlotView.onDataChanged(model.getItemCoordinate(), model.getGroupData());
    ...
    public int renderSlot(GLCanvas canvas, int index, int pass, int width, int height) {
        ...
        ListAlbumSlidingWindow.AlbumEntry entry = mDataWindow.get(index);
        ...
        //Log.d("dengjianzhang", "renderSlot entry.content="+ entry.content);  
        ...
        */
        if (entry.mediaType == MediaObject.MEDIA_TYPE_VIDEO
                ...
                //&& !(entry.item.getMediaData().isLivePhoto) //modify by even c687 temp
    ...
    private int renderOverlay(GLCanvas canvas, int index,
    		ListAlbumSlidingWindow.AlbumEntry entry, int width, int height) {
        int renderRequestFlags = 0;
    ...
    private class MyDataModelListener implements ListAlbumSlidingWindow.Listener {
        @Override
		...
		@Override
		public void onDataChanged(ArrayList<ItemCoordinate> mItemCoordinate,
				ArrayList<GroupData> mGroupData) {
			// TODO Auto-generated method stub
			mSlotView.onDataChanged(mItemCoordinate,mGroupData);
			mSlotView.invalidate();	
		}
...
//			// TODO Auto-generated method stub
//			mSlotView.setItemCoordinate(item);
//		}
//
//		@Override
//		public void onGroupDataChanged(ArrayList<GroupData> item) {
//			// TODO Auto-generated method stub
//			mSlotView.setGroupData(item);
//			mSlotView.invalidate();
//		}
    }
  ...
  //********************************************************************
    ...
    private boolean drawCurrentSlotDynamic(ListAlbumSlidingWindow.AlbumEntry entry, GLCanvas canvas, int index,
