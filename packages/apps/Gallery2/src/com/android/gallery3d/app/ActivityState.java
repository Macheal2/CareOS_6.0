...
abstract public class ActivityState {
    ...
    protected void onCreate(Bundle data, Bundle storedState) {
    	...
    	if(mActivity.getComponentName().getClassName().contains("com.android.camera")){
   		 	mBackgroundColor = getCameraBackgroundColor();
    	}else if (getBackgroundColorId() == -1) {
	...
	//modify by even C687 start
	protected float[] getCameraBackgroundColor() {
    ...
    protected boolean mNotSetActionBarVisibiltyInCappu = false;//modify by even C687 start

	//modify by even C687 start temp
