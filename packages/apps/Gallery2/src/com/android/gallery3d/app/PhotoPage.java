...
public abstract class PhotoPage extends ActivityState implements
    ...
    private static final String TAG1 = "GalleryActionBar123";
    ...
    private static final int HIDE_BARS_TIMEOUT = 3500000;//modify by even 3500 
    ...
    private volatile boolean mSingleTapUpAllowed = false;//moidfy by even
            ...
            case R.id.photopage_bottom_control_delete:
                ...
                builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                    	...
                    	mMenuExecutor.startSingleItemAction(R.id.action_delete, mCurrentPhoto.getPath());    
                        arg0.dismiss();
                    }
                });
    ...
    private void refreshHidingMessage() {
        ...
        if (!mIsMenuVisible && !mPhotoView.getFilmMode()) {
            mHandler.sendEmptyMessageDelayed(MSG_HIDE_BARS, HIDE_BARS_TIMEOUT*10000);//modify by even
        }
    }
    ...
    /// @}
        ...
        //modify by even
        //stop single tap
        Log.i(TAG1, "<onSingleTapConfirmed>");
        if(mSingleTapUpAllowed == false)
        {
            return;
        }
    ...
    protected void onResume() {
        ...
        //if (!mShowBars) { 
          if(true){
            ...
            if (mAppBridge != null && mCurrentIndex == 0
                    && !mPhotoView.getFilmMode()) {
                mActivity.getGLRoot().setLightsOutMode(true);//false  //modify by even
            } else {
                mActivity.getGLRoot().setLightsOutMode(true);
            }
            /// @}
    ...
    protected void onDestroy() {
        ...
        //modify by even end
        mNotSetActionBarVisibiltyInCappu = false;
