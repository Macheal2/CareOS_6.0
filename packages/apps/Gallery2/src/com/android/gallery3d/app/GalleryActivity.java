...
public final class GalleryActivity extends AbstractGalleryActivity implements OnCancelListener {
    ...
    public static final String KEY_TAB_VIEW = "tab-view";//modify by even C687 start
    ...
    /// @}
    //modify by even C687 start
    private Button mCameraAlbumPage;
    private Button mAlbumSetPage;
    public static View   mTab;
    private ActivityState oldState =null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCameraAlbumPage= (Button)findViewById(R.id.camera_button);
        
        mCameraAlbumPage.setOnClickListener(new OnClickListener(){

			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				if(oldState!=getStateManager().getTopState()){
					oldState=getStateManager().getTopState();
					startCameraAlbumPage();
					setTabButtom(true);
				}
			}
        	
        });
        mAlbumSetPage= (Button)findViewById(R.id.gallery_button);
        mAlbumSetPage.setOnClickListener(new OnClickListener(){
	...
	//modify by even C687 start
    private void setTabButtom(boolean isCameraAlbumPage){
    	if(isCameraAlbumPage){
    		ColorStateList mColor=getResources().getColorStateList(R.color.tab_text_focused);
    		mCameraAlbumPage.setTextColor(mColor);
    		Drawable drawable= getResources().getDrawable(R.drawable.tab_camera_selected_focused);
    		/// 这一步必须要做,否则不会显示.
    		drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    		mCameraAlbumPage.setCompoundDrawables(null, drawable, null, null);  		
    		mColor=getResources().getColorStateList(R.color.tab_text);
    		mAlbumSetPage.setTextColor(mColor);
    		drawable= getResources().getDrawable(R.drawable.tab_albums);
    		/// 这一步必须要做,否则不会显示.
    		drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    		mAlbumSetPage.setCompoundDrawables(null, drawable, null, null); 
    		mCameraAlbumPage.setEnabled(false);
    		mAlbumSetPage.setEnabled(true);
    	}else{
    		mCameraAlbumPage.setEnabled(true);
    		mAlbumSetPage.setEnabled(false);
    		ColorStateList mColor=getResources().getColorStateList(R.color.tab_text);
    		mCameraAlbumPage.setTextColor(mColor);  	
    		Drawable drawable= getResources().getDrawable(R.drawable.tab_camera);
    		/// 这一步必须要做,否则不会显示.
    		drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    		mCameraAlbumPage.setCompoundDrawables(null, drawable, null, null);
    		mColor=getResources().getColorStateList(R.color.tab_text_focused);
    		mAlbumSetPage.setTextColor(mColor);   	
    		drawable= getResources().getDrawable(R.drawable.tab_albums_selected_focused);
    		/// 这一步必须要做,否则不会显示.
    		drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    		mAlbumSetPage.setCompoundDrawables(null, drawable, null, null); 		
    	}
    ...
    public void startDefaultPage() {
        ...
        if(oldState==null){//modify by even C687 start
        	data.putBoolean(KEY_TAB_VIEW, false);
        	getStateManager().startState(AlbumSetPage.class, data);
        }else{
        	data.putBoolean(KEY_TAB_VIEW, true);
        	getStateManager().switchState(oldState, AlbumSetPage.class, data);
        }
       // getStateManager().startState(AlbumSetPage.class, data);
    ...
    //modify by even C687 start
    public void startCameraAlbumPage() {
        PicasaSource.showSignInReminder(this);
        String defaultPath ="/local/all/"+MediaSetUtils.CAMERA_BUCKET_ID;
        Bundle data = new Bundle();
        data.putString(AlbumSetPage.KEY_MEDIA_PATH,defaultPath);
        if(oldState==null){    	 
        	 getStateManager().startState(MagcommAlbumPage.class, data);
        }else{     	
        	getStateManager().switchState(oldState, MagcommAlbumPage.class, data);
        }
    ...
    protected void onPause() {
        ...
        /// @}
        //START: added by Yar @20170728
        overridePendingTransition(android.R.anim.fade_in,
                android.R.anim.fade_out);
        //END: added by Yar @20170728
    }
