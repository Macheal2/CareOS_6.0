...
public class AbstractGalleryActivity extends Activity implements GalleryContext {
    ...
    public void onConfigurationChanged(Configuration config) {
        ...
        //toggleStatusBarByOrientation(); //modify by even C687 start
        /// M: [BUG.ADD] @{
        ...
        if (mHasPausedActivity) {
            //mGLRootView.setVisibility(View.GONE);//dengjianzhang@20151113 //modify by even C687 start
        }
        /// @}
    }
    ...
    protected void onStop() {
        ...
        /// M: [BUG.ADD] @{
        //mGLRootView.setVisibility(View.GONE);//dengjianzhang@20151109  //modify by even C687 start
        /// @}
    }
    ...
    protected void onResume() {
        ...
        //mGLRootView.setVisibility(View.VISIBLE);//dengjianzhang@20151109 //modify by even C687 start
        /// @}
    }
