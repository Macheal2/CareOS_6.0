...
/// @}
    public static class AlbumSetPage {
        ...
        private AlbumSetPage(Context context) {
			...
			//modify by even C687 start
            paddingBottom = r.getDimensionPixelSize(R.dimen.listalbum_padding_bottom);//albumset_padding_bottom);
    ...
    public static class AlbumPage {
        ...
        public int placeholderColor;
		//modify by even C687 start
        public int paddingTop;//dengjianzhang@20150417
        ...
        private AlbumPage(Context context) {
            ...
            paddingTop = r.getDimensionPixelSize(R.dimen.albumset_padding_top);//dengjianzhang@20150417
            /// M: [FEATURE.ADD] fancy layout @{
            if (FancyHelper.isFancyLayoutSupported()) {
    ...
    public static class ListAlbumPage {
        private static ListAlbumPage sInstance;

        public ListSlotView.Spec slotViewSpec;
        public int placeholderColor;
        public int paddingTop;//dengjianzhang@20150417
        
        public static synchronized ListAlbumPage get(Context context) {
            if (sInstance == null) {
                sInstance = new ListAlbumPage(context);
            }
            return sInstance;
        }

        private ListAlbumPage(Context context) {
            Resources r = context.getResources();

            placeholderColor = r.getColor(R.color.list_album_placeholder);

            slotViewSpec = new ListSlotView.Spec();
            slotViewSpec.rowsLand = r.getInteger(R.integer.album_rows_land);
            slotViewSpec.rowsPort = r.getInteger(R.integer.album_rows_port);
            
            paddingTop = r.getDimensionPixelSize(R.dimen.albumset_padding_top);//dengjianzhang@20150417
            slotViewSpec.paddingBottom = r.getDimensionPixelSize(R.dimen.listalbum_padding_bottom);
            
            slotViewSpec.colsLand = 2;
            slotViewSpec.colsPort = 2;
            
            slotViewSpec.slotGap = r.getDimensionPixelSize(R.dimen.album_slot_gap);
            
            slotViewSpec.titleHeight= r.getDimensionPixelSize(R.dimen.title_height);
        }
    }
