...
public class AlarmClockFragment extends DeskClockFragment implements
    ...
    private CareButton mAddAlarmButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CareButton menuButton = (CareButton) v.findViewById(R.id.menu_button);
...
//            }
        ...
        mAddAlarmButton = (CareButton) v.findViewById(R.id.alarm_add_alarm);
        mAddAlarmButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
            	Intent localIntent = new Intent(AlarmClockFragment.this.getActivity(), MagcommAddAlarm.class);
                localIntent.putExtra("alarm_id", -1);
                AlarmClockFragment.this.startActivity(localIntent);
            }
        });
...
//            itemHolder.arrow.setRotation(expanded ? ROTATE_180_DEGREE : 0);
            ...
            itemHolder.collapseExpandArea.setVisibility(View.VISIBLE);
...
//dengjianzhang@20150521 end
            	...
            	itemHolder.label.setText(context.getString(R.string.get_up) + "  ");
            	itemHolder.label.setVisibility(View.VISIBLE);
...
//dengjianzhang@20150521 start	
                	Intent localIntent = new Intent(AlarmClockFragment.this.getActivity(), MagcommAddAlarm.class);
                    localIntent.putExtra("alarm_id", (int)alarm.id);
                    AlarmClockFragment.this.startActivity(localIntent);
//                    if (isAlarmExpanded(alarm)) {
//                        collapseAlarm(itemHolder, true);
//                    } else {
							...
							// TODO Auto-generated method stub
								...
								view.animate().setDuration(ANIMATION_DURATION).alpha(0).translationY(-1)
			                  	  .withEndAction(new Runnable(){
			                  		  ...
			                  		  @Override
			                  		  public void run() {
			                  			asyncDeleteAlarm(mDeletedAlarm);
			                  		  }
			                  	  });
						}
					}).create().show();
...
//dengjianzhang@20150521 end
        ...
        private void setDigitalTimeAlpha(ItemHolder holder, boolean enabled) {
			//dengjianzhang@20150521 start	
            float alpha = enabled ? 1f : 0.3f;//0.69f
