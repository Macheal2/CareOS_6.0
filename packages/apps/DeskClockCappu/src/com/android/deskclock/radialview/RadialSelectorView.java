...
public class RadialSelectorView extends View {
     ...
     */
    public void initialize(Context context,boolean disappearsOut, int selectionDegrees) {
        if (mIsInitialized) {
        ...
        mSelectDrawable = res.getDrawable(R.drawable.magcomm_tyd_minute_thumb_picker);
        mSelectWidth=mSelectDrawable.getIntrinsicWidth();
        mSelectHeight=mSelectDrawable.getIntrinsicHeight();
        
        mDial = res.getDrawable(R.drawable.magcomm_clock_analog_dial_mipmap);
        ...
        setSelection(selectionDegrees, false);
        mIsInitialized = true;
    }
     ...
     */
    public void setSelection(int selectionDegrees, boolean forceDrawDot) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        lineLength += mSelectionRadius/2;

        int pointX = mXCenter + (int) (mDialWidth*0.46 * Math.sin(mSelectionRadians));
        int pointY = mYCenter - (int) (mDialHeight*0.46 * Math.cos(mSelectionRadians));
        ...
        if (this.mSelectDrawable == null)
          ...
          canvas.save();
          canvas.rotate((float)Math.toDegrees(mSelectionRadians), pointX, pointY);
          mSelectDrawable.setBounds(pointX-mSelectWidth / 2, pointY-mSelectHeight / 2, pointX+mSelectWidth / 2, pointY+mSelectHeight / 2);
          mSelectDrawable.draw(canvas);
          canvas.restore();
      //mPaint.setAlpha(255);
      //canvas.drawCircle(pointX, pointY, (mSelectionRadius/2), mPaint);
//        mPaint.setAlpha(51);
