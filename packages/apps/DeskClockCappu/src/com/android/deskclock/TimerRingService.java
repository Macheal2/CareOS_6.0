...
public class TimerRingService extends Service implements AudioManager.OnAudioFocusChangeListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mRingTypeIndex=intent.getIntExtra(Utils.RING_TYPE_INDEX, Utils.RING_TYPE_TIMERALER);  //dengjianzhang@20150521 start      
        play();
...
//dengjianzhang@20150521 start 
        ...
        String ringtone = prefs.getString(Timers.TIMER_DEFAULT_RINGTONE, "");
...
//dengjianzhang@20150521 end
        ...
        try {
            ...
            if (mTelephonyManager.getCallState()
            	...
            	if(mRingTypeIndex==Utils.RING_TYPE_TIMERALER){//dengjianzhang@20150521 start 
