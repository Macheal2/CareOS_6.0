...
//dengjianzhang@20150521 start	
        mDial = r.getDrawable(R.drawable.magcomm_world_clock_white_mipmap);
        mHourHand = r.getDrawable(R.drawable.magcomm_world_clock_white_hour_mipmap);
        mMinuteHand = r.getDrawable(R.drawable.magcomm_world_clock_white_minute_mipmap);
        mSecondHand = r.getDrawable(R.drawable.magcomm_world_clock_white_second_mipmap);
