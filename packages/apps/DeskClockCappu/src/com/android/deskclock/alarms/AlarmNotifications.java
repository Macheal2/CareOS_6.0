...
public final class AlarmNotifications {
    ...
    public static void showAlarmNotification(Context context, AlarmInstance instance) {
        ...
        /** M: Using AlarmStateManager to launch MagcommAlarmActivity but not to launch it directly,
         * so that we can update the notification before the MagcommAlarmActivity is launched
         * @{ */
        ...
        Intent fullScreenIntent = AlarmInstance.createIntent(context, MagcommAlarmActivity.class,//dengjianzhang@20150519
                instance.mId);
    ...
    public static void updateAlarmNotification(Context context, AlarmInstance instance) {
        ...
        // Setup Content Action
        Intent contentIntent = AlarmInstance.createIntent(context, MagcommAlarmActivity.class,//dengjianzhang@20150519
                instance.mId);
