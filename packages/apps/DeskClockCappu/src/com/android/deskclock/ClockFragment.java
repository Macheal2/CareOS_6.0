...
public class ClockFragment extends DeskClockFragment implements OnSharedPreferenceChangeListener {
    ...
    private View mDigitalClock, mAnalogClock, mClockFrame, mHairline,ViemAddClock;//dengjianzhang@20150521 start	
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mClockFrame == null) {
            ...
            //mHairline.setVisibility(View.GONE);//dengjianzhang@20150521 start	
            // The main clock frame needs its own touch listener for night mode now.
            //v.setOnTouchListener(longPressNightMode);//dengjianzhang@20150521 start	
        }
        //mList.setOnTouchListener(longPressNightMode);//dengjianzhang@20150521 start	
        ...
        ViemAddClock= v.findViewById(R.id.cities_button);
        ViemAddClock.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                final Activity activity = getActivity();
        ...
        Utils.setTimeFormat((TextClock) (mDigitalClock.findViewById(R.id.digital_clock)),
                (int) getResources().getDimension(R.dimen.label_font_size));//dengjianzhang@20150521 start R.dimen.main_ampm_font_size	
...
//        if (mAdapter.getCount() == 0) {//dengjianzhang@20150521 start 
