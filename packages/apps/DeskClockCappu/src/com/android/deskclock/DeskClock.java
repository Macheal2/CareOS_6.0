...
import com.android.deskclock.stopwatch.MagcommStopwatchFragment;
import com.android.deskclock.stopwatch.StopwatchService;
import com.android.deskclock.stopwatch.Stopwatches;
import com.android.deskclock.timer.MagcommTimerFragment;
...
public class DeskClock extends Activity implements LabelDialogFragment.TimerLabelDialogHandler,
    ...
    private static Context mContext;//dengjianzhang@20150521 start 
   ...
   /* public static final int RTL_ALARM_TAB_INDEX = 3;
    ...
    public void onNewIntent(Intent newIntent) {
        ...
        android.util.Log.e("liukun","tab = " + tab);
        if (tab != -1) {
            if (mActionBar != null) {
    ...
    private void initViews() {
        ...
        mCancel = (ImageButton)findViewById(R.id.topbar_back);
        mClockBtn = (Button)findViewById(R.id.topbar_clock);
        mAlarmBtn = (Button)findViewById(R.id.topbar_alarm);
        android.util.Log.e("liukun","11111");
        ...
        mCancel.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                	view.setBackgroundColor(Color.parseColor("#1e8bd9"));
        ...
        mClockBtn.setOnClickListener(new OnClickListener() {
        	@Override
        	public void onClick(View view) {
        		mTabsAdapter.notifySelectedPage(1);
        ...
        mAlarmBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
            	mTabsAdapter.notifySelectedPage(0);
    ...
    private void createTabs(int selectedIndex) {
        ...
        if (mActionBar != null) {
            ...
            if(true || selectedIndex==ALARM_TAB_INDEX){
            	mAlarmTab = mActionBar.newTab();
            	mAlarmTab.setCustomView(R.layout.magcomm_actionbar_alarm);//dengjianzhang@20150521 start 
            	//mAlarmTab.setIcon(R.drawable.alarm_tab);
            	mAlarmTab.setText(R.string.menu_alarm);//dengjianzhang@20150521 start 
            ...
            if(true || selectedIndex==CLOCK_TAB_INDEX){
            	mClockTab = mActionBar.newTab();
            	mClockTab.setCustomView(R.layout.magcomm_actionbar_clock);//dengjianzhang@20150521 start 
            	//mClockTab.setIcon(R.drawable.clock_tab);
            	mClockTab.setText(R.string.menu_clock);//dengjianzhang@20150521 start 
            	mClockTab.setContentDescription(R.string.menu_clock);
            	mTabsAdapter.addTab(mClockTab, MagcommClockFragment.class, CLOCK_TAB_INDEX);
            }
            mViewPager.setCurrentItem(selectedIndex);
//            mTimerTab = mActionBar.newTab();
//            mTimerTab.setCustomView(R.layout.magcomm_actionbar_time);//dengjianzhang@20150521 start 
//            mTimerTab.setIcon(R.drawable.timer_tab);
//            mTimerTab.setText(R.string.menu_timer);//dengjianzhang@20150521 start 
//            mTimerTab.setContentDescription(R.string.menu_timer);
//            mTabsAdapter.addTab(mTimerTab, MagcommTimerFragment.class, TIMER_TAB_INDEX);
//
//            mStopwatchTab = mActionBar.newTab();
//            mStopwatchTab.setCustomView(R.layout.magcomm_actionbar_stopwatch);//dengjianzhang@20150521 start 
//            mStopwatchTab.setIcon(R.drawable.stopwatch_tab);
//            mStopwatchTab.setText(R.string.menu_stopwatch);//dengjianzhang@20150521 start 
//            mStopwatchTab.setContentDescription(R.string.menu_stopwatch);
//            mTabsAdapter.addTab(mStopwatchTab, MagcommStopwatchFragment.class, STOPWATCH_TAB_INDEX);

            //mActionBar.setSelectedNavigationItem(0);
            mActionBar.hide();//added by yzs
            mTabsAdapter.notifySelectedPage(selectedIndex);
            android.util.Log.e("liukun","selectedIndex = " + selectedIndex);
        }
    }
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mContext=this;//dengjianzhang@20150521 start 
        mIsFirstLaunch = true;
        ...
        if (icicle != null) {
            ...
            if (mLastHourColor != UNKNOWN_COLOR_ID) {
               // getWindow().getDecorView().setBackgroundColor(mLastHourColor);//dengjianzhang@20150521 start 
            }
        }
        ...
        Intent i = getIntent();
        if (i != null) {
            int tab = i.getIntExtra(SELECT_TAB_INTENT_EXTRA, CLOCK_TAB_INDEX);//ALARM_TAB_INDEX);//-1);
            if (tab != -1) {
                mSelectedTab = tab;
            }
        }
    ...
    protected void onResume() {
        ...
        Utils.cancelTimesNotifications(this);//dengjianzhang@20150521 start 
    }
    ...
    public void onPause() {
        ...
        Utils.showTimesNotifications(this);//dengjianzhang@20150521 start 
        super.onPause();
    }
    ...
    private void updateMenu(Menu menu) {
        ...
        if (mActionBar.getSelectedNavigationIndex() == ALARM_TAB_INDEX) {
            ...
            nightMode.setVisible(false);//true//dengjianzhang@20150521 start 
        }
    }
...
//        final int duration;
//        if (mLastHourColor == UNKNOWN_COLOR_ID) {
//            mLastHourColor = getResources().getColor(R.color.magcomm_default_background);
...
//dengjianzhang@20150521 start     
    public static String getLabelDefault() {
        return mContext.getString(R.string.get_up);   
	}
//dengjianzhang@20150521 end
}
