...
public class Timers {
    ...
    public static final int PAGE_SETUP_TIMER = 1;
    public static final int PAGE_COUNTDOWN_TIMER = 2;
    public static final String TIMER_FRAGMENT_PAGE = "timer_page";
    public static final String TIMER_RUN_STATE = "timer_run_state";
    public static final String TIMER_ORIGINAL_TIME = "timer_original_time";
    public static final String TIMER_REMAINDER_MILLISECS = "timer_remainder_millisec";
    public static final String TIMER_MARK = "timer_elapsed_real_time";
    public static final String TIMER_DEFAULT_RINGTONE = "timer_default_ringtone";
    public static final String NOTIF_TIMES_SHOW = "notif_times_show";
    public static final String NOTIF_TIMES_CANCEL = "notif_times_cancel";
    public static final String NOTIF_TIMES_STOP = "notif_times_stop";
