...
//import com.android.deskclock.DeskClock;//dengjianzhang@20151125
...
public final class Alarm implements Parcelable, ClockContract.AlarmsColumns {
    ...
    public Alarm(int hour, int minutes) {
        ...
        this.label = "";
        //this.label =DeskClock.getLabelDefault();//dengjianzhang@20151125
...
//        if (label == null || label.length() == 0) {//dengjianzhang@20151125
//        	label =DeskClock.getLabelDefault();
//        }
...
//        }
    ...
    public String getLabelOrDefault(Context context) {
        if (label == null || label.length() == 0) {
            return context.getString(R.string.get_up);//dengjianzhang@20151125 R.string.default_label 
        }
        return label;
    }
