...
public class RecordParamsSetting {
    ...
    private static int[] sOutFormatArray = new int[] { MediaRecorder.OutputFormat.THREE_GPP,
            MediaRecorder.OutputFormat.AMR_NB, MediaRecorder.OutputFormat.AMR_WB};
    public static int outFormatMax=3;
    //hejianfeng add end 
	...
	//hejianfeng add start 
	static int[] getOutFormatStringIDArray() {
        int[] outFormartStringIDArray = null;
        outFormartStringIDArray = new int[outFormatMax];
        outFormartStringIDArray[0] = R.string.recording_out_format_3gpp;
        outFormartStringIDArray[1] = R.string.recording_out_format_amr;
        outFormartStringIDArray[2] = R.string.recording_out_format_awb;
        return outFormartStringIDArray;
    }
    static int getOutSelectFormat(int which) {
        return sOutFormatArray[which];
    }
	//hejianfeng add end 
