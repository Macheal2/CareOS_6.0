...
//import android.app.AlertDialog;  by jojo 20170817
...
//        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());// by jojo 20170817
        CareDialog.Builder builder = new CareDialog.Builder(getActivity());
...
//        AlertDialog dialog = (AlertDialog) getDialog();//by jojo 20170817
    	CareDialog dialog = (CareDialog) getDialog();
        if (null != dialog) {
            if (single) {
