...
public class CareTimePicker extends FrameLayout {
    ...
    private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = new OnTimeChangedListener() {
        public void onTimeChanged(CareTimePicker view, int hourOfDay, int minute) {
        }
    };
    ...
    @SuppressLint("NewApi")
    public CareTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        int layoutResourceId = R.layout.care_time_picker;
        ...
        // hour
        mHourSpinner = (CareNumberPicker) findViewById(R.id.hour);
        ...
        // minute
        mMinuteSpinner = (CareNumberPicker) findViewById(R.id.minute);
    ...
    private void updateHourControl() {
        if (is24HourView()) {
            ...
            mHourSpinner.setFormatter(CareNumberPicker.getTwoDigitFormatter());
        } else {
    ...
    private void updateInputState() {
        ...
        // value and having the IME up makes no sense.mContext. 
