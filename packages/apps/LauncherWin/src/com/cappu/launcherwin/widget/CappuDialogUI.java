...
public class CappuDialogUI extends Dialog implements View.OnClickListener, DialogInterface.OnClickListener {
    ...
    public CappuDialogUI(Context context, int dialogStyle) {
        ...
        mLinearLayoutOne = (LinearLayout) mContentView.findViewById(R.id.i99_dialog_content_only_one);
        mLinearLayoutButtons = (LinearLayout) mContentView.findViewById(R.id.i99_dialog_content_buttons);
        ...
        mDivide = (View) mContentView.findViewById(R.id.second_divid);
    ...
    public void setMessageGravide(boolean inCenter) {
        if (inCenter) {
        ...
        if (listener != null) {
            mButtonLeft.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.onClick(CappuDialogUI.this, DialogInterface.BUTTON_NEGATIVE);
                }
            });
        }
    }
    ...
    public void setPositiveButton(CharSequence text, final DialogInterface.OnClickListener listener) {
        ...
        if (listener != null) {
            mButtonRight.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.onClick(CappuDialogUI.this, DialogInterface.BUTTON_POSITIVE);
                }
            });
        }
    }
    ...
    public void setCancelButton(CharSequence text, final DialogInterface.OnClickListener listener) {
        ...
        if (listener != null) {
            mButtonMiddle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.onClick(CappuDialogUI.this, DialogInterface.BUTTON_NEUTRAL);
                }
            });
        }
    }
