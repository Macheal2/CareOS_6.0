...
import com.cappu.launcherwin.zipUtil.unzip.Unzip;
import com.cappu.launcherwin.zipUtil.util.ArchiveMaintainer;
import com.cappu.launcherwin.zipUtil.util.InternalZipConstants;
import com.cappu.launcherwin.zipUtil.util.Zip4jUtil;
import com.cappu.launcherwin.zipUtil.zip.ZipEngine;
...
public class ZipFile {
    ...
    public ZipFile(File zipFile) throws ZipException {
        if (zipFile == null) {
            throw new ZipException("Input zip file parameter is not null", ZipExceptionConstants.inputZipParamIsNull);
        }
