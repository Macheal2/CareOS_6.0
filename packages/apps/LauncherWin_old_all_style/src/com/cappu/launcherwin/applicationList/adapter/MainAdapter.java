...
public class MainAdapter extends BaseAdapter {
    ...
    public View getView(int index, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {           
            convertView = mInflater.inflate(R.layout.grid_menu_item, null);
            ...
            //holder.bg = (LinearLayout) convertView.findViewById(R.id.itembg);
        ...
        if (info != null) {
            ...
            //int bg_id = (index >= tools.Modulesbg.length) ? (index % tools.Modulesbg.length) : index;
            //holder.bg.setBackgroundResource(tools.Modulesbg[bg_id]);
            holder.menuInfo = info;
        }        
        return convertView;
    }
}