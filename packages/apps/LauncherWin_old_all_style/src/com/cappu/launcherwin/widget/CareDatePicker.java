...
import com.cappu.launcherwin.widget.CareNumberPicker.OnValueChangeListener;
...
public class CareDatePicker extends FrameLayout {
    ...
    Context mContext;
    public CareDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        int layoutResourceId = R.layout.care_date_picker;
        ...
        OnValueChangeListener onChangeListener = new OnValueChangeListener() {
            public void onValueChange(CareNumberPicker picker, int oldVal, int newVal) {
                ...
                if (picker == mDaySpinner) {
                    ...
                    Log.i("HHJ", "picker == mMonthSpinner");
        ...
        // day
        mDaySpinner = (CareNumberPicker) findViewById(R.id.day);
        ...
        // month
        mMonthSpinner = (CareNumberPicker) findViewById(R.id.month);
        ...
        // year
        mYearSpinner = (CareNumberPicker) findViewById(R.id.year);
    ...
    public long getMinDate() {
        return 0;//mCalendarView.getMinDate();
    }
    ...
    public long getMaxDate() {
        return 0;//mCalendarView.getMaxDate();
    }
    ...
    public boolean getCalendarViewShown() {
        return true;//mCalendarView.isShown();
    }
