             ...
             switch (msg.what) {
                 ...
                 case CONNECTIVITY_CHANGEING: 
                     if (mGPRSKookView.mImageView != null) {
                             ...
                             } else if(ThemeManager.getInstance().getCurrentThemeType(mLauncherContext) == ThemeManager.THEME_SIMPLENESSSTYLE){
                                 mGPRSKookView.mImageView.setImageResource(R.anim.gprs_animation_mode_six);
