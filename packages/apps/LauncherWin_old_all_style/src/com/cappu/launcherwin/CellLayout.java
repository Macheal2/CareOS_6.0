...
//    public ArrayList<BubbleView> mList= new ArrayList<BubbleView>();
    ...
    public CellLayout(Context context) {
        ...
        if(ThemeManager.getInstance().getCurrentThemeType(getContext()) == ThemeManager.THEME_CHINESESTYLE
        		|| ThemeManager.getInstance().getCurrentThemeType() == ThemeManager.THEME_TWELVE_GRIDS){
            mCellPadding = 0;
        ...
        if(ThemeManager.getInstance().getCurrentThemeType()==ThemeManager.THEME_TWELVE_GRIDS){
			setBackgroundResource(R.drawable.cell_twelve_grids_middle);
		}
