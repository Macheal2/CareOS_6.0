...
public class CappuHSView extends LinearLayout implements OnPageChangeListener{
    ...
    public CappuHSView(Context context){
        ...
        int margin = 0;
        if(ThemeManager.getInstance().getCurrentThemeType(getContext()) == ThemeManager.THEME_CLASSICAL){
            margin = DensityUtil.dip2px(getContext(), 0.5);
        }else if(ThemeManager.getInstance().getCurrentThemeType(getContext()) == ThemeManager.THEME_CHINESESTYLE){
            margin = DensityUtil.dip2px(getContext(), 0.5);
        }else{
        ...
        if(ThemeManager.getInstance().getCurrentThemeType(mContext) == ThemeManager.THEME_SIMPLENESSSTYLE){//modify by wangyang
            lpChildLeft.topMargin = 10;
            lpChildLeft.bottomMargin = DensityUtil.dip2px(mContext, 10);
        }
        ...
        if(ThemeManager.getInstance().getCurrentThemeType(getContext()) == ThemeManager.THEME_SIMPLENESSSTYLE){//modify by wangyang
            lpChildRight.topMargin = 10;
            lpChildRight.bottomMargin = DensityUtil.dip2px(mContext, 10);
        }
