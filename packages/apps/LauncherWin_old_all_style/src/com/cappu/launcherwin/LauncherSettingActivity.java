...
// End of Cappu:liukun
    ...
    protected void onResume() {
        ...
        }else if(themeType == ThemeManager.THEME_SIMPLE){
        	theme_layout.setSubContent(R.string.theme_select_classical);
        }else if(themeType == ThemeManager.THEME_CHINESESTYLE){
        	theme_layout.setSubContent(R.string.theme_select_chinesestyle);
        }else if(themeType == ThemeManager.THEME_SIMPLENESSSTYLE){
        	theme_layout.setSubContent(R.string.theme_select_simpleness);
        }
        //hejianfeng add start for 4x3
        else if(themeType == ThemeManager.THEME_TWELVE_GRIDS){
        	theme_layout.setSubContent(R.string.theme_select_twelve_grids);
        }else if(themeType==ThemeManager.THEME_NINE_GRIDS){
        	theme_layout.setSubContent(R.string.theme_select_nine_grids);
        }
        if(themeType == ThemeManager.THEME_TWELVE_GRIDS||themeType==ThemeManager.THEME_NINE_GRIDS){
