...
public class TelecomUtils {
   ...
   /**
	...
	//caiji add for Care_OS incoming call speech
    public static boolean getRingingSpeechState(Context context){
		int state = Settings.Global.getInt(context.getContentResolver(), "contacts_speech_status", -1);
